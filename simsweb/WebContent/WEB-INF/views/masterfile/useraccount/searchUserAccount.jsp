...
<body>
	...
	<form:form action="/simsweb/searchUserAccount" method="GET"  modelAttribute="userAccount" cssClass="form-horizontal" >
		...
		<div align="center" style="position: sticky; top: 0; background-color: white;">
			...
			<div align="center" style="padding-top: 10px;">
				<form:label path="emp.lastName" >Last/First Name:</form:label>
		      	<form:input id="lastNameId" path="emp.lastName"/>	    		
		    	<input class="btn btn-default " type="submit" value="Search">
		      	<input class="btn btn-default" type="button" id="closeButton" value="Add New" onclick="window.location.href = '/simsweb/goToAddUserAccount';">
		    </div>		
			<hr>
		</div>
							...
							<table class="table table-striped table-hover table-bordered table-responsive" style="font-size: 11px;">
								...
								<c:forEach items="${resultList}" var="model" varStatus = "row">
								    <tr>
								    	...
								    	<td><a href="#" onclick="goToEdit(${model.id});" >${model.emp.fullName2}</a></td>
