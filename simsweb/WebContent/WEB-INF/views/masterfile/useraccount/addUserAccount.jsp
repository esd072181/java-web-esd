...
<body>
	...
	<div style="width: 100%;">
		...
		<form:form action="/simsweb/saveUserAccount" method="post" modelAttribute="userAccount" cssClass="form-horizontal">
				...
				<tr>
					...
					<td>
						<div class="form-group">
							<form:label path="emp.id" cssClass="col-sm-2 control-label">Employee:</form:label>
							<div class="col-xs-3">
								<form:select id="empListId" path="emp.id"  items="${empList}"  itemValue="id"   itemLabel="fullName" cssClass="form-control input-sm">
								</form:select>
			    			</div>
						</div>					
					</td>
