...
<body>
	...
	<div style="width: 100%;">
		...
		<form:form action="/simsweb/updateEmployee" method="post" modelAttribute="employee"  cssClass="form-horizontal">
		    ...
		    <div align="center">
		    	...
		    	<label style="font-size: 24px;">Update Employee</label>		
		    </div>
				...
				<tr>
					...
					<td>
						<div class="form-group">
							<form:label path="empType.id" cssClass="col-sm-2 control-label">Type:</form:label>
							<div class="col-xs-3">
								<form:select id="empTypeListId" path="empType.id" items="${empTypeList}"  itemValue="id"   itemLabel="listValue" cssClass="form-control input-sm">
								</form:select>
			    			</div>
						</div>					
					</td>
						...
						<div class="form-group">
							...
							<c:choose>
								<c:when test="${isSuccess == true}">
									<input class="btn btn-default" type="button" value="Close" onclick="window.location.href = '/simsweb/goToSearchEmployee';">
								</c:when>
								<c:otherwise>
									<input class="btn btn-default" type="submit" value="Submit/Update">
									<input class="btn btn-default" type="button" value="Cancel" onclick="window.location.href = '/simsweb/goToSearchEmployee';">
								</c:otherwise>
							</c:choose>
							</div>
						</div>					
