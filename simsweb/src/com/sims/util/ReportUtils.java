...
public class ReportUtils {
	 ...
	 * @throws Exception
	 */
	public static boolean generatePrescriptionReport(String title, String reportFile, File destFile) throws Exception{
		
	    Map<String, Object> paramMap = new HashMap<>();
		
	    //Header
//	    paramMap.put("LabName", SIMSConstant.STORE_NAME);
//	    paramMap.put("LabAddress", SIMSConstant.STORE_ADDRESS);
//	    paramMap.put("LabTelNo", SIMSConstant.STORE_TEL_NO);
