...
public class ReportUtils {
	 ...
	 * @throws Exception
	 */
	public static boolean generateLabExamReport(String title, String reportFile, File destFile, PatientLabRequest patientLabRequest, Object model) throws Exception{
		
	    Map<String, Object> paramMap = new HashMap<>();
		
	    //Header
	    paramMap.put("LabName", LRMSConstant.LAB_NAME);
	    paramMap.put("LabAddress", LRMSConstant.LAB_ADDRESS);
	    paramMap.put("LabTelNo", LRMSConstant.LAB_TEL_NO);
	    paramMap.put("LabRequestNo", patientLabRequest.getLabRequestNo());
	    paramMap.put("PatientName", patientLabRequest.getPatient().getFullName());
	    paramMap.put("Sex", patientLabRequest.getPatient().getGender());
	    paramMap.put("Age", String.valueOf(patientLabRequest.getAge()));
	    paramMap.put("Date", DateUtils.sqlDateToString(patientLabRequest.getRequestDate()));
	    paramMap.put("RequestingPhysician", patientLabRequest.getProfessional().getFullName());
