...
<body>
	...
	<div style="width: 100%;">
		...
		<form:form action="/lrmsweb/saveLabRequest" method="post" modelAttribute="patientLabReq" cssClass="form-horizontal">

			<br>

			<div align="center">
				<img src="resources/img/new_labreq.png" alt="PatientLabRequest" height="50" width="50">
				<label style="font-size: 24px;">Laboratory Examination Request Form</label>		
			</div>
				...
				<table style="width: 100%;">
					...
					<tr>
						...
						<td>
							<div class="form-group">
								<form:label path="labExamId" cssClass="col-sm-2 control-label">Lab Exam:</form:label>
								<div class="col-xs-3">
									<form:select id="labExamListId" path="labExamId" items="${labExamList}"  itemValue="id"   itemLabel="description" cssClass="form-control input-sm">
									</form:select>
				    			</div>
							</div>		
						</td>
					...
					<tr>
						...
						<td>
							<div class="form-group">
								<form:label path="professional.id" cssClass="col-sm-2 control-label">Requesting Physician:</form:label>
								<div class="col-xs-3">
						...
						<td>
							<div class="form-group">
								...
								<c:choose>
									...
									<input class="btn btn-default" type="button" value="Go To Lab Exam Request Details" onclick="viewLabRequest(${patientLabReq.id});">
										<input class="btn btn-default" type="button" value="Close" onclick="window.location.href = '/lrmsweb/goToSearchPatientForLabRequest';">
									</c:when>
									<c:otherwise>
										<input class="btn btn-default" type="submit" value="Submit/Save">
										<input class="btn btn-default" type="button" value="Cancel" onclick="window.location.href = '/lrmsweb/goToSearchPatientForLabRequest';">
									</c:otherwise>
								</c:choose>
								</div>
							</div>
