	...
	<script>
	  $('#reportId').click(function(){
		...
		function viewReport(labReqNo, patientLabExamIdParam) {
			window.open('showLabExamReport?templateId=503&labReqNo=' + labReqNo + "&patientLabExamIdParam=" + patientLabExamIdParam,'popUpWindow','height=700,width=900,left=100,top=100,resizable=yes,scrollbars=yes,toolbar=yes,menubar=no,location=no,directories=no, status=yes');
		}
	</script>
	<style>
	 .labelName{
