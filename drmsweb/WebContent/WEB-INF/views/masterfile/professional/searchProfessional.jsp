...
<body>
	...
	<form:form action="/drmsweb/searchProfessional" method="GET"  modelAttribute="professional" cssClass="form-horizontal" >
			...
			<div align="center" style="position: sticky; top: 0; background-color: white;">
			    ...
			    <div align="center" style="padding-top: 10px;">
	    			...
	    			<input class="btn btn-default " type="submit" value="Search">
	      			<input class="btn btn-default" type="button" id="closeButton" value="Add New" onclick="window.location.href = '/drmsweb/goToAddProfessional';">
				</div>		
				<hr>
			</div>	
