...
<body>
	...
	<div style="width: 100%">
		...
		<form:form action="/drmsweb/updateUserAccount" method="post" modelAttribute="userAccount"  cssClass="form-horizontal">
						...
						<div class="form-group">
							...
							<c:choose>
								<c:when test="${isSuccess == true}">
									<input class="btn btn-default" type="button" value="Close" onclick="window.location.href = '/drmsweb/goToSearchUserAccount';">
								</c:when>
								<c:otherwise>
									<input class="btn btn-default" type="submit" value="Submit/Update">
									<input class="btn btn-default" type="button" value="Cancel" onclick="window.location.href = '/drmsweb/goToSearchUserAccount';">
								</c:otherwise>
							</c:choose>
							</div>
						</div>					
