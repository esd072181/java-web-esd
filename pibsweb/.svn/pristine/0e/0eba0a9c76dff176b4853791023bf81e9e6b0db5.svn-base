...
public class BillingDiscountModule implements PIBSModule {

	private final static Logger logger = Logger.getLogger(BillingDiscountModule.class);
	...
	public Map<String, Object> executeRequest(HashMap<String, Object> dataMap)
		...
		try {
			...
			BillingDiscountBo bo = (BillingDiscountBo) dataMap.get(MapConstant.BEAN);
