...
import com.pibs.bo.RoomCategoryBo;
import com.pibs.constant.ActionConstant;
import com.pibs.constant.MapConstant;
import com.pibs.util.PIBSUtils;

public class RoomCategoryModule implements PIBSModule {
	
	private final static Logger logger = Logger.getLogger(RoomCategoryModule.class);
	...
	public Map<String, Object> executeRequest(HashMap<String, Object> dataMap)
		...
		try {
			...
			RoomCategoryBo bo = (RoomCategoryBo) dataMap.get(MapConstant.BEAN);
