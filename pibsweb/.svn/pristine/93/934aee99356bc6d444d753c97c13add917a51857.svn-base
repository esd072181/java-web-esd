		...
		<html:form action="/equipment.do" styleId="idForm">
				...
				<div>
					<div>
						...
						<html:button styleId="btnSearchId" property="command" onclick="getEquipment(1,'filter');" value="Search" styleClass="btn btn-primary"></html:button>
						<html:button property="command" onclick="getEquipment(1,'showall');" value="Show All" styleClass="btn btn-primary"></html:button>
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<html:button property="command" onclick="goToAddEquipment();" value="Add New Record" styleClass="btn btn-primary"></html:button>
