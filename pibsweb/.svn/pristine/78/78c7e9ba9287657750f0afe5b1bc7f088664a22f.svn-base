...
import com.pibs.bo.UserBo;
import com.pibs.constant.ActionConstant;
import com.pibs.constant.MapConstant;
import com.pibs.util.PIBSUtils;

public class UserModule implements PIBSModule {
	
	private final static Logger logger = Logger.getLogger(UserModule.class);
	...
	public Map<String, Object> executeRequest(HashMap<String, Object> dataMap)
		...
		try {
			...
			UserBo bo = (UserBo) dataMap.get(MapConstant.BEAN);
			...
			switch(action) {
				...
				case ActionConstant.RESTORE: returnMap = bo.restoreRecord(dataMap);
						break;
				case ActionConstant.UPDATE_USERNAME_PASSWORD: returnMap = bo.updateUsernamePassword(dataMap);
						break;
				case ActionConstant.GET_DATA_BY_CRITERIA: returnMap = bo.getDataByUsernamePassword(dataMap);
						break;
				default: break;
			};	
		}catch (Exception e) {
