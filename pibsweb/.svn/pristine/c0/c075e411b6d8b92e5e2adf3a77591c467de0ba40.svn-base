...
<div class="row">
  ...
  <div class="col-sm-10 divSpace" >
	...
	<div style="height: 30%; padding-top: 0px;" align="left">
		<div style="width: 50%;">
			<h3>Nursery Inquiry</h3>
		</div>
		<html:form action="/nurseryInquiry.do" styleId="idForm">
				<div>
					<html:errors/>
				</div>
				<div>
					<div>
						<label>Search Baby:</label>
						<html:text property="criteria" styleId="idSearchCriteria" size="25" ></html:text>
						<html:button property="command" onclick="getBabyForNurseryInquiry(1,'filter');" value="Search" styleClass="btn btn-primary" styleId="btnSearchId"></html:button>
					</div>
