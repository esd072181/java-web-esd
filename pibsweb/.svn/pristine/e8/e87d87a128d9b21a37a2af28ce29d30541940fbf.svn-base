...
<div class="row">
  ...
  <div class="col-sm-10 divSpace" >
	...
	<div style="height: 30%; padding-top: 0px;" align="left">
		<div style="width: 50%;">
			<h3>Patient Bill History</h3>
		</div>
		<html:form action="/patientBillHistory.do" styleId="idForm">
				<div>
					<html:errors/>
				</div>
				<div>
					<div>
						...
						<html:button property="command" onclick="getPatientForPatientBillHistory(1,'filter');" value="Search" styleClass="btn btn-primary" styleId="btnSearchId"></html:button>
					</div>
