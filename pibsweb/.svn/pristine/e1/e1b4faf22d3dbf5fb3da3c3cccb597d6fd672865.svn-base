...
<div class="row">
  ...
  <div class="col-sm-10" style="margin-left: 10px;">
	...
	<div style="height: 30%;">
		<h3 style="font-weight: bolder;">Nursery List Report</h3>
		...
		<html:form action="/rptNursery.do" styleId="idForm">
				<div>
					<html:errors/>
				</div>
				<div>
					<div>
						<table>
							<tr>
								...
								<td>
									<html:select  name="rptNurseryForm" property="searchCriteria" styleId="searchCriteriaId" onchange="showDateCriteria(this.value);" >
										<html:optionsCollection name="rptNurseryForm" property="nurseryCriteriaLOV" label="listValue" value="id"/>				 		
									</html:select>									
								</td>
							</tr>
							<tr>
						...
						<div class="control-group">
							...
							<div class="controls">
								<html:button styleId="btnSearchFilter"  property="command" onclick="getRptNursery();" value="Search and Generate Report" styleClass="btn btn-primary"></html:button>
							</div>
						</div>						
					</div>
				</div>			
