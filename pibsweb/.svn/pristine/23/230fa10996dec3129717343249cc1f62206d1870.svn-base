...
public class BillingPaymentModule implements PIBSModule {

	private final static Logger logger = Logger.getLogger(BillingPaymentModule.class);
	...
	public Map<String, Object> executeRequest(HashMap<String, Object> dataMap)
		...
		try {
			...
			BillingPaymentBo bo = (BillingPaymentBo) dataMap.get(MapConstant.BEAN);
