...
public class ProfessionalBoImpl implements ProfessionalBo {
	...
	public void setProfessionalDao(ProfessionalDao dao) {
		this.dao = dao;
	}
	...
	@Override
	public Map<String, Object> getActiveDataByIdType(HashMap<String, Object> criteriaMap)
			throws Exception {
		// TODO Auto-generated method stub
		return dao.getActiveDataByIdType(criteriaMap);
	}
