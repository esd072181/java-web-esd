 ...
 * @since 19May2018
 */
public class RptDiscountModule implements PIBSModule {
	
	private final static Logger logger = Logger.getLogger(RptDiscountModule.class);
	...
	public Map<String, Object> executeRequest(HashMap<String, Object> dataMap)
		...
		try {
			...
			RptDiscountBo bo = (RptDiscountBo) dataMap.get(MapConstant.BEAN);
