...
import com.pibs.bo.MonitorPhysicalExaminationBo;
import com.pibs.dao.MonitorPhysicalExaminationDao;

public class MonitorPhysicalExaminationBoImpl implements MonitorPhysicalExaminationBo {

	private MonitorPhysicalExaminationDao dao;
	
	public MonitorPhysicalExaminationDao getMonitorPhysicalExaminationDao() {
		return dao;
	}

	public void setMonitorPhysicalExaminationDao(MonitorPhysicalExaminationDao dao) {
		this.dao = dao;
	}
