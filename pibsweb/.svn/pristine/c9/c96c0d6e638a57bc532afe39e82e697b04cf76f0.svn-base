		...
		<html:form action="/monitorMedicalSupply.do" styleId="idForm">
				...
				<div>
					<div>
						...
						<html:button property="command" onclick="getMedicalSupplyForMonitorPatient(1,'filter','${monitorMedicalSupplyForm.patientCaseSystemId}');" value="Search" styleClass="btn btn-primary" styleId="btnSearchId"></html:button>
