		...
		<h3>Additional Services - Edit Record</h3>
			<html:form action="/additionalServices.do" styleId="idForm" >
				<fieldset>
					...
					<html:hidden property="id" value="${additionalServicesForm.id}"/>
					<table>
						<tr>
									...
									<div class="controls">
										<c:choose>
											<c:when test="${additionalServicesForm.transactionStatus == true}">
												<html:button property="btnClose" styleClass="btn btn-primary" style="width: 100px;" onclick="goToAdditionalServices();" value="Close"></html:button>
											</c:when>
											<c:otherwise>
												<html:button property="btnUpdate" styleClass="btn btn-primary" style="width: 100px;" onclick="updateAdditionalServices();" value="Update"></html:button>
												&nbsp;&nbsp;
												<html:button property="btnCancel" styleClass="btn btn-primary" style="width: 100px;" onclick="goToAdditionalServices();" value="Cancel"></html:button>
											</c:otherwise>
										</c:choose>						
									</div>							
								</div>
