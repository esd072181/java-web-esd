	...
	<div class="col-sm-2">
 	...
 	<div class="col-sm-10 divSpace">
		...
		<div style="height: 30%; padding-top: 0px;" align="left">
			<h3>Laboratory Examination - Edit Record</h3>
			<html:form action="/laboratoryExamination.do" styleId="idForm" >
				<fieldset>
					...
					<html:hidden property="id" value="${laboratoryExaminationForm.id}"/>
					<table>
						<tr>
						...
						<tr>
							...
							<td style="padding-left: 5px;">
								<html:text style="text-align: right;" styleId="feeId" property="fee" styleClass="input-xlarge"  size="20" maxlength="20" value="${laboratoryExaminationForm.fee}" disabled="${laboratoryExaminationForm.transactionStatus}"></html:text><br>
							</td>
						</tr>
						<tr height="15px"></tr>				
						<tr>
									...
									<div class="controls">
										<c:choose>
											<c:when test="${laboratoryExaminationForm.transactionStatus == true}">
												<html:button property="btnClose" styleClass="btn btn-primary" style="width: 100px;" onclick="goToLaboratoryExamination();" value="Close"></html:button>
											</c:when>
											<c:otherwise>
												<html:button property="btnUpdate" styleClass="btn btn-primary" style="width: 100px;" onclick="updateLaboratoryExamination();" value="Update"></html:button>
												&nbsp;&nbsp;
												<html:button property="btnCancel" styleClass="btn btn-primary" style="width: 100px;" onclick="goToLaboratoryExamination();" value="Cancel"></html:button>
											</c:otherwise>
										</c:choose>						
									</div>							
								</div>
