	...
	<div class="col-sm-2">
 	...
 	<div class="col-sm-10 divSpace">
		...
		<div style="height: 30%; padding-top: 0px;" align="left">
			<h3>Room Category - Add New Record</h3>
										...
										<div class="controls">
											<c:choose>
												<c:when test="${roomCategoryForm.transactionStatus == true}">
													<html:button property="btnAddNew" styleClass="btn btn-primary" onclick="goToAddRoomCategory();" value="Add New Record"></html:button>
													&nbsp;&nbsp;
												...
												<c:otherwise>
													<html:button property="btnSave" styleClass="btn btn-primary" style="width: 100px;" onclick="saveRoomCategory();" value="Save"></html:button>
													&nbsp;&nbsp;
