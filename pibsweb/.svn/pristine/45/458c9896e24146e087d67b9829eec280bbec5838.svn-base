...
public class MonitorLaboratoryExaminationModule implements PIBSModule {

	private final static Logger logger = Logger.getLogger(MonitorLaboratoryExaminationModule.class);
	...
	public Map<String, Object> executeRequest(HashMap<String, Object> dataMap)
		...
		try {
			...
			MonitorLaboratoryExaminationBo bo = (MonitorLaboratoryExaminationBo) dataMap.get(MapConstant.BEAN);
