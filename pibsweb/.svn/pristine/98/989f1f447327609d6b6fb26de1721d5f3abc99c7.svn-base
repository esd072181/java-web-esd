 ...
 * @since 18May2018
 */
public class RptEmployeeModule implements PIBSModule {
	
	private final static Logger logger = Logger.getLogger(RptEmployeeModule.class);
	...
	public Map<String, Object> executeRequest(HashMap<String, Object> dataMap)
		...
		try {
			...
			RptEmployeeBo bo = (RptEmployeeBo) dataMap.get(MapConstant.BEAN);
