		...
		<html:form action="/patient.do" styleId="idForm">
				...
				<div>
					<div>
						...
						<html:button property="command" onclick="getPatient(1,'filter');" value="Search" styleClass="btn btn-primary" styleId="btnSearchId"></html:button>
						<html:button property="command" onclick="getPatient(1,'showall');" value="Show All" styleClass="btn btn-primary"></html:button>
