...
public class MonitorDoctorBoImpl implements MonitorDoctorBo {

	private MonitorDoctorDao dao;
	
	public MonitorDoctorDao getMonitorDoctorDao() {
		return dao;
	}

	public void setMonitorDoctorDao(MonitorDoctorDao dao) {
		this.dao = dao;
	}
