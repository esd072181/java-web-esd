			...
			<html:form action="/employee.do" styleId="idForm">
				...
				<fieldset>
					...
					<table>
						...
						<tr height="5px"></tr>
						<tr>
							<td><label  class="control-label top-spacing" for="empCategoryId">Category</label></td>
							<td style="padding-left: 5px;">
								...
								<div class="control-group">
									<div class="controls">
										<c:choose>
											...
											<c:otherwise>
												<html:button property="btnSave" styleClass="btn btn-primary" style="width: 100px;" onclick="saveEmployee();" value="Save"></html:button>
												&nbsp;&nbsp;
