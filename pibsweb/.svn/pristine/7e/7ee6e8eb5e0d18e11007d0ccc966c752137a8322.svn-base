	...
	<div style="height: 30%; padding-top: 0px;" align="left">
	  ...
	  <div>
	  	<table>
	  		...
	  		<tr>
	  			<td><h3>Medical Supply</h3></td>
	  			<td class="padLeft5">
	  				<html:button property="btnAdd" styleClass="btn btn-primary btnMonitoringSmall" onclick="goToMonitorMedicalSupplySearch('${monitorMedicalSupplyForm.patientCaseSystemId}');" value="Add New"></html:button>
	  			</td>
	  			<td>
	  ...
	  <div class="table-responsive" align="left" >
		...
		<c:when test="${monitorMedicalSupplyForm.entityList != null}">
			<table  id="tableId" class="table table-bordered table-striped table-condensed table-hover context-menu-table" style="width: 98%;">  
				...
				<logic:iterate name="monitorMedicalSupplyForm" property="entityList" type="com.pibs.model.MonitorMedicalSupply" id="model">
					<tr>
