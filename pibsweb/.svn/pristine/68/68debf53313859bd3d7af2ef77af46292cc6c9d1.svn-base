...
import com.pibs.bo.MonitorDoctorBo;
import com.pibs.constant.ActionConstant;
import com.pibs.constant.MapConstant;
import com.pibs.util.PIBSUtils;

public class MonitorDoctorModule implements PIBSModule {

	private final static Logger logger = Logger.getLogger(MonitorDoctorModule.class);
	...
	public Map<String, Object> executeRequest(HashMap<String, Object> dataMap)
		...
		try {
			...
			MonitorDoctorBo bo = (MonitorDoctorBo) dataMap.get(MapConstant.BEAN);
