...
public class RadiologyModule implements PIBSModule {

	private final static Logger logger = Logger.getLogger(RadiologyModule.class);
	...
	public Map<String, Object> executeRequest(HashMap<String, Object> dataMap)
		...
		try {
			...
			RadiologyBo bo = (RadiologyBo) dataMap.get(MapConstant.BEAN);
