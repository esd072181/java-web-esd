...
public class MonitorAdditionalServicesModule implements PIBSModule {

	private final static Logger logger = Logger.getLogger(MonitorAdditionalServicesModule.class);
	...
	public Map<String, Object> executeRequest(HashMap<String, Object> dataMap)
		...
		try {
			...
			MonitorAdditionalServicesBo bo = (MonitorAdditionalServicesBo) dataMap.get(MapConstant.BEAN);
