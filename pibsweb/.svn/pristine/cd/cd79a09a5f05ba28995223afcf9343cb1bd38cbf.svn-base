...
public class MonitorMedicalSupplyModule implements PIBSModule {

	private final static Logger logger = Logger.getLogger(MonitorMedicalSupplyModule.class);
	...
	public Map<String, Object> executeRequest(HashMap<String, Object> dataMap)
		...
		try {
			...
			MonitorMedicalSupplyBo bo = (MonitorMedicalSupplyBo) dataMap.get(MapConstant.BEAN);
