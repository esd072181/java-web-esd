		...
		<html:form action="/radiology.do" styleId="idForm">
				...
				<div>
					<div>
						...
						<html:button styleId="btnSearchId" property="command" onclick="getRadiology(1,'filter');" value="Search" styleClass="btn btn-primary"></html:button>
						<html:button property="command" onclick="getRadiology(1,'showall');" value="Show All" styleClass="btn btn-primary"></html:button>
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<html:button property="command" onclick="goToAddRadiology();" value="Add New Record" styleClass="btn btn-primary"></html:button>
