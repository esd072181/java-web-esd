...
import com.pibs.bo.AdditionalServicesCategoryBo;
import com.pibs.dao.AdditionalServicesCategoryDao;

public class AdditionalServicesCategoryBoImpl implements
		AdditionalServicesCategoryBo {

	private AdditionalServicesCategoryDao dao;
	
	public AdditionalServicesCategoryDao getAdditionalServicesCategoryDao() {
		return dao;
	}

	public void setAdditionalServicesCategoryDao(AdditionalServicesCategoryDao dao) {
		this.dao = dao;
	}
