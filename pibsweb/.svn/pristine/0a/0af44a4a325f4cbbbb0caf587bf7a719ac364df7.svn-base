...
<div class="row">
  ...
  <div class="col-sm-10 divSpace" >
	...
	<div style="height: 30%; padding-top: 0px;" align="left">
		...
		<html:form action="/patientHistory.do" styleId="idForm">
				<div>
					<html:errors/>
				</div>
				<div>
					<div>
						...
						<html:button property="command" onclick="getPatientForPatientHistory(1,'filter');" value="Search" styleClass="btn btn-primary" styleId="btnSearchId"></html:button>
					</div>
