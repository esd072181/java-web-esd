...
public class MonitorRoomModule implements PIBSModule {

	private final static Logger logger = Logger.getLogger(MonitorRoomModule.class);
	...
	public Map<String, Object> executeRequest(HashMap<String, Object> dataMap)
		...
		try {
			...
			MonitorRoomBo bo = (MonitorRoomBo) dataMap.get(MapConstant.BEAN);
