		...
		<h3>Specialization - Edit Record</h3>
			<html:form action="/specialization.do" styleId="idForm" >
				<fieldset>
					...
					<html:hidden property="id" value="${specializationForm.id}"/>
					<table>
						<tr>
								...
								<div class="control-group">
									<div class="controls">
										<c:choose>
											...
											<c:otherwise>
												<html:button property="btnUpdate" styleClass="btn btn-primary" style="width: 100px;" onclick="updateSpecialization();" value="Update"></html:button>
												&nbsp;&nbsp;
