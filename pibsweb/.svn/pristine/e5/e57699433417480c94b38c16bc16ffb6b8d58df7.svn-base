 ...
 * Window&gt;Preferences&gt;Java&gt;Code Generation&gt;Code and Comments
 */
public class BuildingModule implements PIBSModule{
	
	private final static Logger logger = Logger.getLogger(BuildingModule.class);
	...
	public Map<String, Object> executeRequest(HashMap<String, Object> dataMap) throws Exception{
		...
		try {
			...
			BuildingBo bo = (BuildingBo) dataMap.get(MapConstant.BEAN);
