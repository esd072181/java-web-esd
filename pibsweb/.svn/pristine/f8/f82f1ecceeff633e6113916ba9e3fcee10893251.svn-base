		...
		<html:form action="/medicalSupply.do" styleId="idForm">
				...
				<div>
					<div>
						...
						<html:button styleId="btnSearchId" property="command" onclick="getMedicalSupply(1,'filter');" value="Search" styleClass="btn btn-primary"></html:button>
						<html:button property="command" onclick="getMedicalSupply(1,'showall');" value="Show All" styleClass="btn btn-primary"></html:button>
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<html:button property="command" onclick="goToAddMedicalSupply();" value="Add New Record" styleClass="btn btn-primary"></html:button>
