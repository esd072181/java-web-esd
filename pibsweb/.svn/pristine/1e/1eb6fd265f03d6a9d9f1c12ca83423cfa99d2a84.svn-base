...
import com.pibs.bo.AdditionalServicesBo;
import com.pibs.dao.AdditionalServicesDao;

public class AdditionalServicesBoImpl implements AdditionalServicesBo {

	private AdditionalServicesDao dao;
	
	public AdditionalServicesDao getAdditionalServicesDao() {
		return dao;
	}

	public void setAdditionalServicesDao(AdditionalServicesDao dao) {
		this.dao = dao;
	}
