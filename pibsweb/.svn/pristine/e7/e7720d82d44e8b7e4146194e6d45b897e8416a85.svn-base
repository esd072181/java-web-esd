...
public interface UserBo {
	...
	Map<String, Object> updateUsernamePassword(HashMap<String, Object> dataMap) throws Exception;
	Map<String, Object> getDataByUsernamePassword(HashMap<String, Object> criteriaMap) throws Exception;
}
