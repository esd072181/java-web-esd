...
public class MedicalAbstractModule implements PIBSModule {

	private final static Logger logger = Logger.getLogger(MedicalAbstractModule.class);
	...
	public Map<String, Object> executeRequest(HashMap<String, Object> dataMap)
		...
		try {
			...
			MedicalAbstractBo bo = (MedicalAbstractBo) dataMap.get(MapConstant.BEAN);
