...
public class SurgeryDaoImpl implements SurgeryDao {
	...
	private final static Logger logger = Logger.getLogger(SurgeryDaoImpl.class);
	...
	public Map<String, Object> save(HashMap<String, Object> dataMap) throws Exception{
		...
		Surgery model = (Surgery) dataMap.get(MapConstant.CLASS_DATA);
		...
		StringBuffer qry =  new StringBuffer("insert into pibs.file_surgery (");
				qry.append("surgerytypeid ");
		...
		StringBuffer qryLog =  new StringBuffer("insert into pibs.file_surgery (");
				qryLog.append("surgerytypeid ");
				...
				qryLog.append(" ( ");
				qryLog.append(model.getSurgeryTypeId());
		...
		PIBSUtils.writeLogDebug(logger, "SQL: "+qryLog.toString());
		  ...
		  try {
			  ...
			  pstmt.setInt(1, model.getSurgeryTypeId());
			  ...
			  if (statusInt == 1) {
				  conn.commit();
				  System.out.println("Inserted into Surgery table successfully..");
				  status = true;
			  }
		  } catch (Exception e) {
			  conn.rollback();
	...
	public Map<String, Object> update(HashMap<String, Object> dataMap) throws Exception{
		...
		StringBuffer qry =  new StringBuffer("update pibs.file_surgery set ");	
			qry.append(" surgerytypeid=? ");
			qry.append(" ,description=? ");
			qry.append(" ,remarks=? ");
			qry.append(" ,fee=? ");
		...
		StringBuffer qryLog =  new StringBuffer("update pibs.file_surgery set ");
			qryLog.append(" surgerytypeid="+model.getSurgeryTypeId());
		...
		PIBSUtils.writeLogDebug(logger, "SQL: "+qryLog.toString());
		 ...
		 try {
			...
			if (statusInt == 1) {
				conn.commit();
				System.out.println("Surgery record (id: " +model.getId()+") updated successfully..");
				status = true;
			}
		} catch (Exception e) {
			conn.rollback();
	...
	public Map<String, Object> delete(HashMap<String, Object> dataMap) throws Exception{
		...
		PIBSUtils.writeLogDebug(logger, "SQL: "+qryLog.toString());
		 ...
		 try {
			...
			if (statusInt == 1) {
				conn.commit();
				System.out.println("Surgery record (id: " +model.getId()+") deleted successfully..");
				status = true;
			}
		} catch (Exception e) {
			conn.rollback();
	...
	public Map<String, Object> search(HashMap<String, Object> criteriaMap) throws Exception{
		...
		PIBSUtils.writeLogInfo(logger, MiscConstant.LOGGING_MESSSAGE_SEARCH);
			 ...
			 PreparedStatement pstmt = null;
			  ...
			  List<Surgery> rsList = new ArrayList<Surgery>();
			 ...
			 try {
				 ...
				 if (category.equals(ActionConstant.SEARCHALL)) {
					 sql = new StringBuffer("select a.id,a.surgerytypeid,a.description,a.remarks,b.listvalue as type,a.fee,a.createdby,a.createdon,a.modifiedby,a.modifiedon,a.version,a.active ");
					 	sql.append(" from pibs.file_surgery a, pibs.list_value b");
					 	sql.append(" where a.surgerytypeid = b.id ");
				...
				PIBSUtils.writeLogDebug(logger, "SQL: "+sql.toString());
				 ...
				 while(rs.next()) {
		    		 ...
		    		 model.setSurgeryTypeId(rs.getInt(2));
		    		 model.setDescription(rs.getString(3));
		    		 model.setRemarks(rs.getString(4));
		    		 model.setSurgeryTypeName(rs.getString(5));
		     ...
		     try {
			     ...
			     if (category.equals(ActionConstant.SEARCHALL)) {
			    	 sqlCount = new StringBuffer("select count(*) from pibs.file_surgery where active = true");	 
			     }else {
			    	 sqlCount = new StringBuffer("select count(*) from pibs.file_surgery where  (description ilike '%"+criteria+"%' or remarks ilike '%"+criteria+"%') and active = true");	 
			     } 
	...
	public Map<String, Object> getDataById(HashMap<String, Object> criteriaMap)
		...
		PIBSUtils.writeLogInfo(logger, MiscConstant.LOGGING_MESSSAGE_GETDATA_BY_ID);
		    ...
		    Surgery model = (Surgery) criteriaMap.get(MapConstant.CLASS_DATA);
			 ...
			 try {
				 ...
				 StringBuffer sql = new StringBuffer();				
				 	sql.append("select a.id,a.surgerytypeid,a.description,a.remarks,a.fee,b.listvalue as type,a.createdby,a.createdon,a.modifiedby,a.modifiedon,a.version,a.active ");
				 	sql.append(" from pibs.file_surgery a, pibs.list_value b");
				 	sql.append(" where a.surgerytypeid = b.id ");
				 	sql.append(" and a.id = ?");

				 StringBuffer sqlLog = new StringBuffer();				
				 	sqlLog.append("select a.id,a.surgerytypeid,a.description,a.remarks,a.fee,b.listvalue as type,a.createdby,a.createdon,a.modifiedby,a.modifiedon,a.version,a.active ");
				 	sqlLog.append(" from pibs.file_surgery a, pibs.list_value b");
				 	sqlLog.append(" where a.surgerytypeid = b.id ");
				 	sqlLog.append(" and a.id = ?");
				 ...
				 while(rs.next()) {
		    		 ...
		    		 model.setSurgeryTypeName(rs.getString(6));
				 }				 
			 } catch (SQLException e) {
				 throw e;
			 } finally {
	...
	public Map<String, Object> getActiveData() throws Exception {
		...
		PIBSUtils.writeLogInfo(logger, MiscConstant.LOGGING_MESSSAGE_GET_ACTIVE_DATA);
			 ...
			 try {
				 ...
				 StringBuffer sql = new StringBuffer();				
				 	sql.append("select id,surgerytypeid,description,remarks,fee,createdby,createdon,modifiedby,modifiedon,version,active ");
				 	sql.append("from pibs.file_surgery ");
				 	sql.append("where active = true ");
				 	sql.append("order by description");

				 StringBuffer sqlLog = new StringBuffer();				
				 	sqlLog.append("select id,surgerytypeid,description,remarks,fee,createdby,createdon,modifiedby,modifiedon,version,active ");
				 	sqlLog.append("from pibs.file_surgery ");
	...
	public Map<String, Object> getInActiveData(HashMap<String, Object> criteriaMap) throws Exception {
		...
		PIBSUtils.writeLogInfo(logger, MiscConstant.LOGGING_MESSSAGE_GET_INACTIVE_DATA);
		 ...
		 int limit = (int) criteriaMap.get(MapConstant.PAGINATION_LIMIT);
			 ...
			 PreparedStatement pstmt = null;
		     Map<String, Object> returnMap = null;
			 List<Surgery> rsList = new ArrayList<>();
		     ...
		     try {
			    ...
			    sqlCount = new StringBuffer("select count(*) from pibs.file_surgery where active = false");	 
	...
	public Map<String, Object> restore(HashMap<String, Object> dataMap) throws Exception{
		...
		StringBuffer qry =  new StringBuffer("update pibs.file_surgery set ");	
		 ...
		 try {
			...
			if (statusInt == 1) {
				conn.commit();
				System.out.println("Surgery record (id: " +model.getId()+") restored successfully..");
				status = true;
			}
		} catch (Exception e) {
			conn.rollback();
		...
		PIBSUtils.writeLogInfo(logger, MiscConstant.LOGGING_MESSSAGE_SEARCH);
			 ...
			 try {
				 ...
				 sql = new StringBuffer("select a.id,a.description,a.remarks,a.fee,b.listvalue as type,a.createdby,a.createdon,a.modifiedby,a.modifiedon,a.version,a.active ");
				 	...
				 	sql.append(" where a.surgerytypeid = b.id ");
				 	sql.append(" and a.active = true ");
			    	if (MiscConstant.LOV_SURGERY_REPORT_SEARCH_CRITERIA_TYPE == searchCriteria) {
			    		sql.append(" and b.listvalue ilike '%"+searchValue+"%' ");
			    	}
			    	if (MiscConstant.LOV_SURGERY_REPORT_SEARCH_CRITERIA_DESCRIPTION == searchCriteria) {
			    		sql.append(" and a.description ilike '%"+searchValue+"%' ");
			    	}
			    	if (MiscConstant.LOV_SURGERY_REPORT_SEARCH_CRITERIA_REMARKS == searchCriteria) {
