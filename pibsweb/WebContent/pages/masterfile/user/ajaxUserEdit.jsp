					...
					<table>
						<tr>
							...
							<td style="padding-left: 5px;">
								<html:select  styleId="idEmployee" name="userForm" property="employeeId" disabled="true" >
								...
								<div class="control-group">
									<div class="controls">
										<c:choose>
											...
											<c:otherwise>
												<html:button property="btnUpdate" styleClass="btn btn-primary" style="width: 100px;" onclick="updateUser();" value="Update"></html:button>
												&nbsp;&nbsp;
