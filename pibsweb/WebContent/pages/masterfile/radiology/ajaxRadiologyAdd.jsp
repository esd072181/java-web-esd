	...
	<div class="col-sm-2">
 	...
 	<div class="col-sm-10 divSpace">
		...
		<div style="height: 30%; padding-top: 0px;" align="left">
			<h3>Radiology - Add New Record</h3>
					...
					<table>
						<tr>
							...
							<td style="padding-left:5px;">
								<html:select  name="radiologyForm" property="radiologyTypeId" styleId="radiologyTypeIdId" disabled="${radiologyForm.transactionStatus}">
						...
						<tr>
							...
							<td style="padding-left:5px;">
								<html:text styleId="descriptionId" property="description" styleClass="input-xlarge"  size="20" maxlength="20" value="${radiologyForm.description}" disabled="${radiologyForm.transactionStatus}"></html:text><br>
							</td>
						</tr>
						<tr height="5px;"></tr>
						<tr>
						...
						<tr>
							...
							<td style="padding-left:5px;">
								<html:text style="text-align: right;" styleId="feeId" property="fee" styleClass="input-xlarge"  size="20" maxlength="20" value="${radiologyForm.fee}" disabled="${radiologyForm.transactionStatus}"></html:text><br>
							</td>
						</tr>
						<tr height="15px"></tr>
						<tr>
									...
									<div class="controls">
										<c:choose>
											<c:when test="${radiologyForm.transactionStatus == true}">
												<html:button property="btnAddNew" styleClass="btn btn-primary" onclick="goToAddRadiology();" value="Add New Record"></html:button>
												&nbsp;&nbsp;
												<html:button property="btnClose" styleClass="btn btn-primary" style="width: 100px;" onclick="goToRadiology();" value="Close"></html:button>
											</c:when>
											<c:otherwise>
												<html:button property="btnSave" styleClass="btn btn-primary" style="width: 100px;" onclick="saveRadiology();" value="Save"></html:button>
												&nbsp;&nbsp;
												<html:button property="btnCancel" styleClass="btn btn-primary" style="width: 100px;" onclick="goToRadiology();" value="Cancel"></html:button>
											</c:otherwise>
										</c:choose>						
									</div>							
								</div>
