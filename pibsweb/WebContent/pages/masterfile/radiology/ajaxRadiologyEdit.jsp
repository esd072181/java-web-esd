		...
		<h3>Radiology - Edit Record</h3>
			<html:form action="/radiology.do" styleId="idForm" >
				<fieldset>
					...
					<html:hidden property="id" value="${radiologyForm.id}"/>
					<table>
						<tr>
								...
								<div class="control-group">
									<div class="controls">
										<c:choose>
											...
											<c:otherwise>
												<html:button property="btnUpdate" styleClass="btn btn-primary" style="width: 100px;" onclick="updateRadiology();" value="Update"></html:button>
												&nbsp;&nbsp;
