	...
	<div class="col-sm-2">
 	...
 	<div class="col-sm-10 divSpace">
		...
		<div style="height: 30%; padding-top: 0px;" align="left">
			<h3 >Medical Supply - Add New Record</h3>
				...
				<fieldset>
					...
					<table>
						...
						<tr>
							...
							<td style="padding-left: 5px;">
								<input style="text-align: right;" type="text" name="dateManufactured" id="dtManufacturedDatePicker" placeholder="mm/dd/yyyy" />
							</td>
						</tr>
						<tr height="5px;"></tr>
						<tr>
							...
							<td style="padding-left: 5px;">
								<input style="text-align: right;" type="text" name="expirationDate" id="dtExpirationDatePicker" placeholder="mm/dd/yyyy" />
							</td>
						</tr>
						<tr height="5px;"></tr>
						<tr>
									...
									<div class="controls">
										<c:choose>
											<c:when test="${medicalSupplyForm.transactionStatus == true}">
												<html:button property="btnAddNew" styleClass="btn btn-primary" onclick="goToAddMedicalSupply();" value="Add New Record"></html:button>
												&nbsp;&nbsp;
											...
											<c:otherwise>
												<html:button property="btnSave" styleClass="btn btn-primary" style="width: 100px;" onclick="saveMedicalSupply();" value="Save"></html:button>
												&nbsp;&nbsp;
