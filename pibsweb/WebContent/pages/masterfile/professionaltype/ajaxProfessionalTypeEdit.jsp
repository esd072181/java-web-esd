...
<div class="row">
	<div class="col-sm-2">
		...
		<div style="padding-top: 15px; padding-left: 12px;">
			  ...
			  <li onclick="goToProfessionalType();"><a href="#">Add New Record</a></li>
 	...
 	<div class="col-sm-10 divSpace">
		...
		<h3>Professional Type - Edit Record</h3>
			<html:form action="/professionalType.do" styleId="idForm" >
				<fieldset>
					...
					<html:hidden property="id" value="${professionalTypeForm.id}"/>
					<table>
						<tr>
								...
								<div class="control-group">
									<div class="controls">
										<c:choose>
											...
											<c:otherwise>
												<html:button property="btnUpdate" styleClass="btn btn-primary" style="width: 100px;" onclick="updateProfessionalType();" value="Update"></html:button>
												&nbsp;&nbsp;
