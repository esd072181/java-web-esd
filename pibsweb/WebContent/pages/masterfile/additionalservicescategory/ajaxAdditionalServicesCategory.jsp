...
<div class="row">
  ...
  <div class="col-sm-10 divSpace">
	...
	<div style="height: 30%; padding-top: 0px;" align="left">
		<div style="width: 50%;">
			<h3>Additional Services Category</h3>
		</div>
		<html:form action="/additionalServicesCategory.do" styleId="idForm">
				...
				<div>
					<div>
						...
						<html:button styleId="btnSearchId" property="command" onclick="getAdditionalServicesCategory(1,'filter');" value="Search" styleClass="btn btn-primary"></html:button>
						<html:button property="command" onclick="getAdditionalServicesCategory(1,'showall');" value="Show All" styleClass="btn btn-primary"></html:button>
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<html:button property="command" onclick="goToAddAdditionalServicesCategory();" value="Add New Record" styleClass="btn btn-primary"></html:button>
