...
<div class="row">
	<div class="col-sm-2">
 	...
 	<div class="col-sm-10 divSpace">
		...
		<h3>Additional Services Category - Edit Record</h3>
			<html:form action="/additionalServicesCategory.do" styleId="idForm" >
				<fieldset>
					...
					<html:hidden property="id" value="${additionalServicesCategoryForm.id}"/>
					<table>
						<tr>
									...
									<div class="controls">
										<c:choose>
											<c:when test="${additionalServicesCategoryForm.transactionStatus == true}">
												<html:button property="btnClose" styleClass="btn btn-primary" style="width: 100px;" onclick="goToAdditionalServicesCategory();" value="Close"></html:button>
											</c:when>
											<c:otherwise>
												<html:button property="btnUpdate" styleClass="btn btn-primary" style="width: 100px;" onclick="updateAdditionalServicesCategory();" value="Update"></html:button>
												&nbsp;&nbsp;
												<html:button property="btnCancel" styleClass="btn btn-primary" style="width: 100px;" onclick="goToAdditionalServicesCategory();" value="Cancel"></html:button>
											</c:otherwise>
										</c:choose>						
									</div>							
								</div>
