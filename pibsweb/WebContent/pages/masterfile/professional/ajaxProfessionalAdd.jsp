					...
					<table>
							...
							<td style="padding-left: 5px;">
								<c:choose>
									<c:when test="${professionalForm.transactionStatus == true}">
										<input style="text-align: right;" type="text" name="birthday" id="dtBirthdayPicker" value="${professionalForm.birthday}" placeholder="mm/dd/yyyy" disabled="disabled"/>
									</c:when>
									<c:otherwise>
						...
						<tr>
							...
							<td style="padding-left: 5px;">
								<c:choose>
									<c:when test="${professionalForm.transactionStatus == true}">
										<input style="text-align: right;" type="text" name="dateHired" id="dtDateHiredPicker" value="${professionalForm.dateHired}" placeholder="mm/dd/yyyy" disabled="disabled"/>			
									</c:when>
									<c:otherwise>
						...
						<tr>
							...
							<td style="padding-left: 5px;">
								<html:select  name="professionalForm" property="professionalStatusId" disabled="${professionalForm.transactionStatus}">
									 <html:option value="601">Available</html:option>
								...
								<div class="control-group">
									<div class="controls">
										<c:choose>
											...
											<c:otherwise>
												<html:button property="btnSave" styleClass="btn btn-primary" style="width: 100px;" onclick="saveProfessional();" value="Save"></html:button>
												&nbsp;&nbsp;
