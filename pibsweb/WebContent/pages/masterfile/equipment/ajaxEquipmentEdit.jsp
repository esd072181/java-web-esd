		...
		<h3>Equipment - Edit Record</h3>
			<html:form action="/equipment.do" styleId="idForm" >
				<fieldset>
					...
					<html:hidden property="id" value="${equipmentForm.id}"/>
					<table>
						<tr>
								...
								<div class="control-group">
									<div class="controls">
										<c:choose>
											...
											<c:otherwise>
												<html:button property="btnUpdate" styleClass="btn btn-primary" style="width: 100px;" onclick="updateEquipment();" value="Update"></html:button>
												&nbsp;&nbsp;
