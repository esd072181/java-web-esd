...
<div class="row">
  ...
  <div class="col-sm-10" style="margin-left: 10px;">
	...
	<div style="height: 30%;">
		<h3 style="font-weight: bolder;">Room List Report</h3>
		...
		<html:form action="/rptRoom.do" styleId="idForm">
				<div>
					<html:errors/>
				</div>
				<div>
					<div>
						<table>
							<tr>
								...
								<td>
									<html:select  name="rptRoomForm" property="searchCriteria" styleId="searchCriteriaId" >
										<html:optionsCollection name="rptRoomForm" property="roomCriteriaLOV" label="listValue" value="id"/>				 		
									</html:select>									
								</td>
							</tr>
							<tr>
						...
						<div class="control-group">
							...
							<div class="controls">
								<html:button styleId="btnSearchFilter"  property="command" onclick="getRptRoom();" value="Search and Generate Report" styleClass="btn btn-primary"></html:button>
							</div>
						</div>						
					</div>
				</div>			
