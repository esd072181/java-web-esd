		...
		<html:form action="/medicalAbstract.do" styleId="idForm">
				...
				<div>
					<div>
						...
						<html:button property="command" onclick="getPatientForMedicalAbstract(1,'filter');" value="Search" styleClass="btn btn-primary" styleId="btnSearchId"></html:button>
					</div>
