...
<div>
	...
	<html:form action="/saveBillingDiscount.do" styleId="idFormChild">
		<table>
			<html:hidden property="id" value="${billingDiscountForm.id}"/>
			...
			<tr>
				<td colspan="2">
					<c:choose>
						...
						<c:otherwise>
							<html:button property="btnUpdate" styleClass="btn btn-primary btnSaveUpdate" onclick="updateBillingDiscount();" value="Update"></html:button>
