...
$(function() {
	...
	<label style="font-weight: bold; font-size: 20px;">Search for Discount</label>
		
		<html:form action="/billingDiscount.do" styleId="idForm">
				<div>
					<html:errors/>
				</div>
				...
				<div>
					<div>
						...
						<html:button property="command" onclick="getDiscountForBilling(1,'filter','${billingDiscountForm.patientCaseSystemId}');" value="Search" styleClass="btn btn-primary" styleId="btnSearchId"></html:button>
