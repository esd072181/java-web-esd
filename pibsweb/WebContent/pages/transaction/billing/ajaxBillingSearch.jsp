...
<div class="row">
  ...
  <div class="col-sm-10 divSpace" >
	...
	<div style="height: 30%; padding-top: 0px;" align="left">
		<div style="width: 50%;">
			<h3>Search Admitted Patient for Billing</h3>
		</div>
		<html:form action="/billing.do" styleId="idForm">
				...
				<div>
					<div>
						...
						<html:button property="command" onclick="getPatientForBilling(1,'filter');" value="Search" styleClass="btn btn-primary" styleId="btnSearchId"></html:button>
						<html:button property="command" onclick="getPatientForBilling(1,'showall');" value="Show All" styleClass="btn btn-primary"></html:button>
