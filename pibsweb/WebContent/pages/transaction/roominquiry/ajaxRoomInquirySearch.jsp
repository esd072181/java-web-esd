		...
		<html:form action="/roomInquiry.do" styleId="idForm">
				...
				<div>
					<div>
						...
						<html:button property="command" onclick="getRoomForRoomInquiry(1,'occupied');" value="Show Occupied Rooms" styleClass="btn btn-primary" styleId="btnSearchIdOccupied"></html:button>
					</div>
