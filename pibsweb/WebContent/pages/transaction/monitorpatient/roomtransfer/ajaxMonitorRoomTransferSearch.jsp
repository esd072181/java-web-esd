...
$(function() {
	...
	<label style="font-weight: bold; font-size: 20px;">Search for Room to Transfer</label>
		
		<html:form action="/monitorRoomTransfer.do" styleId="idForm">
				<div>
					<html:errors/>
				</div>
				...
				<div>
					<div>
						...
						<html:button property="command" onclick="getRoomTransferForMonitorPatient(1,'filter','${monitorRoomTransferForm.patientCaseSystemId}');" value="Search" styleClass="btn btn-primary" styleId="btnSearchId"></html:button>
