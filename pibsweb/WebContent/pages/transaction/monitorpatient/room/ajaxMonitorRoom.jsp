...
$(function() {
    ...
    $("#idSearchCriteria").focus();
	  ...
	  <div>
	  	<label style="font-weight: bold; font-size: 20px;">Other Room</label>	
	  	<html:button property="btnAdd" styleClass="btn btn-primary btnMonitoringSmallest" onclick="goToMonitorRoomSearch('${monitorRoomForm.patientCaseSystemId}');" value="Add New"></html:button>
		...
		<c:choose>
			<c:when test="${monitorRoomForm.entityList != null}">
				<table  id="tableId" class="table table-bordered table-striped table-condensed table-hover context-menu-table" style="width: 98%;">  
					...
					<logic:iterate name="monitorRoomForm" property="entityList" type="com.pibs.model.MonitorRoom" id="model" indexId="index">
						<tr>
