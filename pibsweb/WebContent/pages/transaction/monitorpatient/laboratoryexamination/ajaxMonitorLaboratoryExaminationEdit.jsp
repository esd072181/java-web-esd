...
$(function() {
	...
	<label style="font-weight: bold; font-size: 20px;">Laboratory Examination Request - Edit Record</label>
	...
	<html:form action="/updateMonitorLaboratoryExamination.do" styleId="idFormChild">
		<table>
			
			<html:hidden property="id" value="${monitorLaboratoryExaminationForm.id}"/>
			...
			<tr>
        		...
        		<td class="padLeft5"><input type="text" style="text-align: right;" name="fee" value="${monitorLaboratoryExaminationForm.fee}" readonly="readonly"></td>
			</tr>
			<tr class="hMargin5"></tr>
			<tr>
 				<td>Qty</td>
        		<td class="padLeft5"><input type="text" style="text-align: right;" id="qtyId" name="qty" value="${monitorLaboratoryExaminationForm.qty}"></td>
			...
			<tr>
				<td colspan="2">
					<c:choose>
						...
						<c:otherwise>
							<html:button property="btnUpdate" styleClass="btn btn-primary btnSaveUpdate" onclick="updateMonitorLaboratoryExamination();" value="Update"></html:button>
