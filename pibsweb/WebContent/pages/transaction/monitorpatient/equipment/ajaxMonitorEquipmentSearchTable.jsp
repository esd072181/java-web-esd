...
<%@ taglib uri="http://java.sun.com/jsp/jstl/functions" prefix="fn" %>
			...
			$('#categoryId').val('${monitorEquipmentForm.category}');
			$('#currentPageId').val('${monitorEquipmentForm.currentPage}');
			</script>
						
						
	<div class="table-responsive" align="left" >
		<c:choose>
		<c:when test="${monitorEquipmentForm.modelList != null}">
			<table  id="tableId" class="table table-bordered table-striped table-condensed table-hover context-menu-table" style="width: 98%;">  
				...
				<logic:iterate name="monitorEquipmentForm" property="modelList" type="com.pibs.model.Equipment" id="model">
					<tr>				 
						<td align="center"><a href="#" onclick="javascript: goToMonitorEquipmentAdd('<bean:write name="model" property="id"/>','${monitorEquipmentForm.patientCaseSystemId}');">Select</a></td>
