		...
		<html:form action="/monitorEquipment.do" styleId="idForm">
				...
				<div>
					<div>
						...
						<html:button property="command" onclick="getEquipmentForMonitorPatient(1,'filter','${monitorEquipmentForm.patientCaseSystemId}');" value="Search" styleClass="btn btn-primary" styleId="btnSearchId"></html:button>
