...
$(function() {
	...
	<label style="font-weight: bold; font-size: 20px;">Radiology Request - Edit Record</label>
	...
	<html:form action="/updateMonitorRadiology.do" styleId="idFormChild">
		<table>
		<html:hidden property="id" value="${monitorRadiologyForm.id}"/>
			...
			<tr>
				<td colspan="2">
					<c:choose>
						...
						<c:otherwise>
							<html:button property="btnUpdate" styleClass="btn btn-primary btnSaveUpdate" onclick="updateMonitorRadiology();" value="Update"></html:button>
