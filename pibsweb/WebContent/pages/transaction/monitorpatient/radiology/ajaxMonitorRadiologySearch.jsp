...
$(function() {
	...
	<label style="font-weight: bold; font-size: 20px;">Search for Radiology</label>
		
		<html:form action="/monitorRadiology.do" styleId="idForm">
				<div>
					<html:errors/>
				</div>
				...
				<div>
					<div>
						...
						<html:button property="command" onclick="getRadiologyForMonitorPatient(1,'filter','${monitorRadiologyForm.patientCaseSystemId}');" value="Search" styleClass="btn btn-primary" styleId="btnSearchId"></html:button>
