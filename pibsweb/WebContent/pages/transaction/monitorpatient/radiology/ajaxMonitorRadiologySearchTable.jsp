...
<%@ taglib uri="http://java.sun.com/jsp/jstl/functions" prefix="fn" %>
			...
			$('#categoryId').val('${monitorRadiologyForm.category}');
			$('#currentPageId').val('${monitorRadiologyForm.currentPage}');
			</script>
						
						
	<div class="table-responsive" align="left" >
		<c:choose>
		<c:when test="${monitorRadiologyForm.modelList != null}">
			<table  id="tableId" class="table table-bordered table-striped table-condensed table-hover context-menu-table" style="width: 98%;">  
				...
				<logic:iterate name="monitorRadiologyForm" property="modelList" type="com.pibs.model.Radiology" id="model">
					<tr>				 
						<td align="center"><a href="#" onclick="javascript: goToMonitorRadiologyAdd('<bean:write name="model" property="id"/>','${monitorRadiologyForm.patientCaseSystemId}');">Select</a></td>
