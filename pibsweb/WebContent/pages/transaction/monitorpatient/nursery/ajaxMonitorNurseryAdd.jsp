...
$(function() {
	...
	<html:form action="/saveMonitorNursery.do" styleId="idFormChild">
		<table>
			...
			<tr>
        		...
        		<td class="padLeft5"><input type="text" id="firstNameId" name="firstName" value="${monitorNurseryForm.firstName}" ></td>
