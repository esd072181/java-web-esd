...
$(function() {
	...
	<label style="font-weight: bold; font-size: 20px;">Search for Surgery</label>
		
		<html:form action="/monitorSurgery.do" styleId="idForm">
				<div>
					<html:errors/>
				</div>
				...
				<div>
					<div>
						...
						<html:button property="command" onclick="getSurgeryForMonitorPatient(1,'filter','${monitorSurgeryForm.patientCaseSystemId}');" value="Search" styleClass="btn btn-primary" styleId="btnSearchId"></html:button>
