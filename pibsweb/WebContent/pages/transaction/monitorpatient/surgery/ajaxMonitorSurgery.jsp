	  ...
	  <div>
	  	<table>
	  		...
	  		<tr>
	  			<td><h3>Surgery</h3></td>
	  			<td class="padLeft5">
	  				<html:button property="btnAdd" styleClass="btn btn-primary btnMonitoringSmall" onclick="goToMonitorSurgerySearch('${monitorSurgeryForm.patientCaseSystemId}');" value="Add New"></html:button>
	  			</td>
	  			<td>
	  ...
	  <div class="table-responsive" align="left" >
		...
		<c:when test="${monitorSurgeryForm.entityList != null}">
			<table  id="tableId" class="table table-bordered table-striped table-condensed table-hover context-menu-table" style="width: 98%;">  
				...
				<logic:iterate name="monitorSurgeryForm" property="entityList" type="com.pibs.model.MonitorSurgery" id="model">
					<tr>			 
