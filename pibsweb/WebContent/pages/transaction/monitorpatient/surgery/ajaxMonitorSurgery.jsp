...
$(function() {
    ...
    $("#idSearchCriteria").focus();
	  ...
	  <div>
	  	<label style="font-weight: bold; font-size: 20px;">Surgery</label>	
	  	<html:button property="btnAdd" styleClass="btn btn-primary btnMonitoringSmallest" onclick="goToMonitorSurgerySearch('${monitorSurgeryForm.patientCaseSystemId}');" value="Add New"></html:button>
	  	<span id="msgId" style="color: blue; padding-left: 100px; display: none;"><bean:message key="msg.updated"/></span>	  
	  </div>

	  <div class="table-responsive" style="padding-top: 10px;" >
		<c:choose>
			<c:when test="${monitorSurgeryForm.entityList != null}">
				<table  id="tableId" class="table table-bordered table-striped table-condensed table-hover context-menu-table" style="width: 98%;">  
					...
					<logic:iterate name="monitorSurgeryForm" property="entityList" type="com.pibs.model.MonitorSurgery" id="model" indexId="index">
						<tr>			 
							...
							<td align="center"><a href="#" onclick="javascript: editMonitorSurgery('<bean:write name="model" property="id"/>');">Edit</a></td>
							<td align="center"><a href="#" onclick="javascript: deleteMonitorSurgery('<bean:write name="model" property="id"/>','${monitorSurgeryForm.patientCaseSystemId}');">Remove</a></td>					
						</tr>
					</logic:iterate>
				</table>
			</c:when>
