...
$(function() {
	...
	<label style="font-weight: bold; font-size: 20px;">Search for Doctor/Professional</label>
		
		<html:form action="/monitorDoctor.do" styleId="idForm">
				<div>
					<html:errors/>
				</div>
				...
				<div>
					<div>
						...
						<html:button property="command" onclick="getDoctorForMonitorPatient(1,'filter','${monitorDoctorForm.patientCaseSystemId}');" value="Search" styleClass="btn btn-primary" styleId="btnSearchId"></html:button>
