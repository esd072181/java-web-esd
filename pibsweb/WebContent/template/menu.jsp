       ...
       <li  class="dropdown">
        ...
        <ul class="dropdown-menu">
        	<c:forEach items="${sessionScope.user_access_list}" var="item">
        		...
        		<c:if test="${item == 1428}">
        			<li><a href="#" onclick="goToNurseryInquirySearch()">Nursery Inquiry</a></li>
        		</c:if>
        		<c:if test="${item == 1429}">
     ...
     <c:if test="${item == 1433}">
     	<li class="dropdown">
     		...
     		<ul class="dropdown-menu">
        		<c:forEach items="${sessionScope.user_access_list}" var="item">
        			<c:if test="${item == 1438}">
        				<li><a href="#"  onclick="goToRptPatient();">Patient List</a></li>
        			</c:if>  
        			<c:if test="${item == 1439}">
        				<li><a href="#"  onclick="goToRptMedicalSupply();">Medical Supply List</a></li>
        			</c:if>
        			<c:if test="${item == 1440}">
        				<li><a href="#"  onclick="goToRptEquipment();">Equipment List</a></li>
        			</c:if>  
        			<c:if test="${item == 1441}">
        				<li><a href="#"  onclick="goToRptLaboratoryExamination();">Laboratory Examination List</a></li>
        			</c:if>
        			<c:if test="${item == 1442}">
        				<li><a href="#"  onclick="goToRptRadiology();">Radiology List</a></li>
        			</c:if> 
        			<c:if test="${item == 1443}">
        				<li><a href="#"  onclick="goToRptSurgery();">Surgery List</a></li>
        			</c:if>     
        			<c:if test="${item == 1444}">
        				<li><a href="#"  onclick="goToRptAdditionalServices();">Additional Services List</a></li>
        			</c:if>
        			<c:if test="${item == 1445}">
        				<li><a href="#"  onclick="goToRptDiscount();">Discount List</a></li>
        			</c:if>  
        			<c:if test="${item == 1446}">
        				<li><a href="#"  onclick="goToRptProfessional();">Professional/Doctor List</a></li>
        			</c:if>  
        			<c:if test="${item == 1447}">
        				<li><a href="#"  onclick="goToRptRoom();">Room List</a></li>
        			</c:if>
        			<c:if test="${item == 1448}">
        				<li><a href="#"  onclick="goToRptEmployee();">Employee List</a></li>
        			</c:if> 
        			<c:if test="${item == 1449}">
        				<li><a href="#"  onclick="goToRptNursery();">Nursery List</a></li>
        			</c:if> 
        			<c:if test="${item == 1450}">
        				<li class="divider"></li>
        				<li><a href="#"  onclick="goToRptPatientHistorySearch();">Patient History</a></li>
        			</c:if>           	
        		</c:forEach>           
        	</ul>    		
        </li>  
