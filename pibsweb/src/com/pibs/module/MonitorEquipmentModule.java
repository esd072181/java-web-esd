...
public class MonitorEquipmentModule implements PIBSModule {

	private final static Logger logger = Logger.getLogger(MonitorEquipmentModule.class);
	...
	public Map<String, Object> executeRequest(HashMap<String, Object> dataMap)
		...
		try {
			...
			MonitorEquipmentBo bo = (MonitorEquipmentBo) dataMap.get(MapConstant.BEAN);
