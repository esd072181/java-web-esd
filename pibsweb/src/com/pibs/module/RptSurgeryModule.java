 ...
 * @since 18May2018
 */
public class RptSurgeryModule implements PIBSModule {
	
	private final static Logger logger = Logger.getLogger(RptSurgeryModule.class);
	...
	public Map<String, Object> executeRequest(HashMap<String, Object> dataMap)
		...
		try {
			...
			RptSurgeryBo bo = (RptSurgeryBo) dataMap.get(MapConstant.BEAN);
