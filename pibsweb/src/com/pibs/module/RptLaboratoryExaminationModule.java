 ...
 * @since 18May2018
 */
public class RptLaboratoryExaminationModule implements PIBSModule {
	
	private final static Logger logger = Logger.getLogger(RptLaboratoryExaminationModule.class);
	...
	public Map<String, Object> executeRequest(HashMap<String, Object> dataMap)
		...
		try {
			...
			RptLaboratoryExaminationBo bo = (RptLaboratoryExaminationBo) dataMap.get(MapConstant.BEAN);
