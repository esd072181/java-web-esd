...
public class MedicationStatementModule implements PIBSModule {

	private final static Logger logger = Logger.getLogger(MedicationStatementModule.class);
	...
	public Map<String, Object> executeRequest(HashMap<String, Object> dataMap)
		...
		try {
			...
			MedicationStatementBo bo = (MedicationStatementBo) dataMap.get(MapConstant.BEAN);
