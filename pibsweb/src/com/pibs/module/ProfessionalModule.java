...
import com.pibs.bo.ProfessionalBo;
import com.pibs.constant.ActionConstant;
import com.pibs.constant.MapConstant;
import com.pibs.util.PIBSUtils;

public class ProfessionalModule implements PIBSModule {

	private final static Logger logger = Logger.getLogger(ProfessionalModule.class);
	...
	public Map<String, Object> executeRequest(HashMap<String, Object> dataMap)
		...
		try {
			...
			ProfessionalBo bo = (ProfessionalBo) dataMap.get(MapConstant.BEAN);
			...
			switch(action) {
				...
				case ActionConstant.DELETE: returnMap = bo.deleteRecord(dataMap);
					    break;
				case ActionConstant.GET_ACTIVE_DATA_BY_ID_TYPE: returnMap = bo.getActiveDataByIdType(dataMap);
						break;
