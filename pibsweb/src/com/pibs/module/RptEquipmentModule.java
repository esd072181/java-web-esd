 ...
 * @since 18May2018
 */
public class RptEquipmentModule implements PIBSModule {
	
	private final static Logger logger = Logger.getLogger(RptEquipmentModule.class);
	...
	public Map<String, Object> executeRequest(HashMap<String, Object> dataMap)
		...
		try {
			...
			RptEquipmentBo bo = (RptEquipmentBo) dataMap.get(MapConstant.BEAN);
