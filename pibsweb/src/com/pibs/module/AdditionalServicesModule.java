...
public class AdditionalServicesModule  implements PIBSModule {

	private final static Logger logger = Logger.getLogger(AdditionalServicesModule.class);
	...
	public Map<String, Object> executeRequest(HashMap<String, Object> dataMap)
		...
		try {
			...
			AdditionalServicesBo bo = (AdditionalServicesBo) dataMap.get(MapConstant.BEAN);
