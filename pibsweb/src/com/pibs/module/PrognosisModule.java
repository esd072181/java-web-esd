...
public class PrognosisModule implements PIBSModule {

	private final static Logger logger = Logger.getLogger(PrognosisModule.class);
	...
	public Map<String, Object> executeRequest(HashMap<String, Object> dataMap)
		...
		try {
			...
			PrognosisBo bo = (PrognosisBo) dataMap.get(MapConstant.BEAN);
