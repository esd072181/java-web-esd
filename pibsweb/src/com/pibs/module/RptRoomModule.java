 ...
 * @since 19May2018
 */
public class RptRoomModule implements PIBSModule {
	
	private final static Logger logger = Logger.getLogger(RptRoomModule.class);
	...
	public Map<String, Object> executeRequest(HashMap<String, Object> dataMap)
		...
		try {
			...
			RptRoomBo bo = (RptRoomBo) dataMap.get(MapConstant.BEAN);
