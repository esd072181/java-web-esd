...
import com.pibs.bo.EquipmentBo;
import com.pibs.constant.ActionConstant;
import com.pibs.constant.MapConstant;
import com.pibs.util.PIBSUtils;

public class EquipmentModule implements PIBSModule {
	
	private final static Logger logger = Logger.getLogger(EquipmentModule.class);
	...
	public Map<String, Object> executeRequest(HashMap<String, Object> dataMap)
		...
		try {
			...
			EquipmentBo bo = (EquipmentBo) dataMap.get(MapConstant.BEAN);
