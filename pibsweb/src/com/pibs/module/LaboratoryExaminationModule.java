...
import com.pibs.bo.LaboratoryExaminationBo;
import com.pibs.constant.ActionConstant;
import com.pibs.constant.MapConstant;
import com.pibs.util.PIBSUtils;

public class LaboratoryExaminationModule implements PIBSModule {

	private final static Logger logger = Logger.getLogger(LaboratoryExaminationModule.class);
	...
	public Map<String, Object> executeRequest(HashMap<String, Object> dataMap)
		...
		try {
			...
			LaboratoryExaminationBo bo = (LaboratoryExaminationBo) dataMap.get(MapConstant.BEAN);
