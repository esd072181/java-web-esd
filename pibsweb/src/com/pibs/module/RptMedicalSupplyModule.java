 ...
 * @since 17May2018
 */
public class RptMedicalSupplyModule implements PIBSModule {
	
	private final static Logger logger = Logger.getLogger(RptMedicalSupplyModule.class);
	...
	public Map<String, Object> executeRequest(HashMap<String, Object> dataMap)
		...
		try {
			...
			RptMedicalSupplyBo bo = (RptMedicalSupplyBo) dataMap.get(MapConstant.BEAN);
