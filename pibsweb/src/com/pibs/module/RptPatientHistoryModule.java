 ...
 * @since 23May2018
 */
public class RptPatientHistoryModule implements PIBSModule {
	
	private final static Logger logger = Logger.getLogger(RptPatientHistoryModule.class);
	...
	public Map<String, Object> executeRequest(HashMap<String, Object> dataMap)
		...
		try {
			...
			RptPatientHistoryBo bo = (RptPatientHistoryBo) dataMap.get(MapConstant.BEAN);
