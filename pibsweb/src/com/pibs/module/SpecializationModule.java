...
import com.pibs.bo.SpecializationBo;
import com.pibs.constant.ActionConstant;
import com.pibs.constant.MapConstant;
import com.pibs.util.PIBSUtils;

public class SpecializationModule implements PIBSModule  {

	private final static Logger logger = Logger.getLogger(SpecializationModule.class);
	...
	public Map<String, Object> executeRequest(HashMap<String, Object> dataMap)
		...
		try {
			...
			SpecializationBo bo = (SpecializationBo) dataMap.get(MapConstant.BEAN);
