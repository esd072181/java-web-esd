...
public class AdditionalServicesCategoryModule implements PIBSModule {

	private final static Logger logger = Logger.getLogger(AdditionalServicesCategoryModule.class);
	...
	public Map<String, Object> executeRequest(HashMap<String, Object> dataMap)
		...
		try {
			...
			AdditionalServicesCategoryBo bo = (AdditionalServicesCategoryBo) dataMap.get(MapConstant.BEAN);
