...
public class MonitorRoomTransferModule implements PIBSModule {

	private final static Logger logger = Logger.getLogger(MonitorRoomTransferModule.class);
	...
	public Map<String, Object> executeRequest(HashMap<String, Object> dataMap)
		...
		try {
			...
			MonitorRoomTransferBo bo = (MonitorRoomTransferBo) dataMap.get(MapConstant.BEAN);
			...
			switch(action) {
				...
				case ActionConstant.GET_DATA: returnMap = bo.getDataById(dataMap);
						break;
				case ActionConstant.GET_DATA_BY_PATIENT_CASE_SYS_ID: returnMap = bo.getDataByPatientCaseSystemId(dataMap);
						break;
