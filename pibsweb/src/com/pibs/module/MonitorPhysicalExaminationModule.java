...
public class MonitorPhysicalExaminationModule implements PIBSModule {

	private final static Logger logger = Logger.getLogger(MonitorPhysicalExaminationModule.class);
	...
	public Map<String, Object> executeRequest(HashMap<String, Object> dataMap)
		...
		try {
			...
			MonitorPhysicalExaminationBo bo = (MonitorPhysicalExaminationBo) dataMap.get(MapConstant.BEAN);
