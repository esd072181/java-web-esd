...
public class MonitorSurgeryModule implements PIBSModule {

	private final static Logger logger = Logger.getLogger(MonitorSurgeryModule.class);
	...
	public Map<String, Object> executeRequest(HashMap<String, Object> dataMap)
		...
		try {
			...
			MonitorSurgeryBo bo = (MonitorSurgeryBo) dataMap.get(MapConstant.BEAN);
