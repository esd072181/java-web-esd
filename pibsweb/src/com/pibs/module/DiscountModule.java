...
public class DiscountModule implements PIBSModule {

	private final static Logger logger = Logger.getLogger(DiscountModule.class);
	...
	public Map<String, Object> executeRequest(HashMap<String, Object> dataMap)
		...
		try {
			...
			DiscountBo bo = (DiscountBo) dataMap.get(MapConstant.BEAN);
