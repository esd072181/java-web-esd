...
public interface RoomDao {
	 ...
	 Map<String, Object> getAvailableRoomsForRoomInquiry(HashMap<String, Object> criteriaMap) throws Exception;
	 Map<String, Object> searchForListReport(HashMap<String, Object> criteriaMap) throws Exception;
	 Map<String, Object> getOccupiedRoomsForRoomInquiry(HashMap<String, Object> criteriaMap) throws Exception;
