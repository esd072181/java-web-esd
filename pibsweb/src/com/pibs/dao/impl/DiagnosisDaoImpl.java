...
public class DiagnosisDaoImpl implements DiagnosisDao {
	...
	private final static Logger logger = Logger.getLogger(DiagnosisDaoImpl.class);
	...
	public Map<String, Object> save(HashMap<String, Object> dataMap) throws Exception{
		...
		Diagnosis model = (Diagnosis) dataMap.get(MapConstant.CLASS_DATA);
		...
		StringBuffer qry =  new StringBuffer("insert into pibs.tran_patient_diagnosis (");  		
				qry.append("patientcasesystemid ");
				qry.append(",statementofdiagnosis ");
		  		qry.append(",remarks ");
		  		qry.append(",dateofdiagnosis ");
		...
		PIBSUtils.writeLogDebug(logger, "SQL: "+qry.toString());
		  ...
		  try {
			  ...
			  pstmt.setString(2, model.getStatementOfDiagnosis());
			  pstmt.setString(3, model.getRemarks());
			  pstmt.setDate(4, model.getDateOfDiagnosis());
			  ...
			  if (statusInt == 1) {
				  conn.commit();
				  System.out.println("Inserted into Diagnosis table successfully..");
				  status = true;
			  }
		  } catch (Exception e) {
			  conn.rollback();
	...
	public Map<String, Object> update(HashMap<String, Object> dataMap) throws Exception{
		...
		StringBuffer qry =  new StringBuffer("update pibs.tran_patient_diagnosis set ");	
			qry.append(" statementofdiagnosis=? ");
			qry.append(" ,remarks=? ");
			qry.append(" ,dateofdiagnosis=? ");
		...
		PIBSUtils.writeLogDebug(logger, "SQL: "+qry.toString());
		 ...
		 try {
			...
			pstmt.setString(1, model.getStatementOfDiagnosis());
			pstmt.setString(2, model.getRemarks());
			pstmt.setDate(3, model.getDateOfDiagnosis());
	...
	public Map<String, Object> getDataById(HashMap<String, Object> criteriaMap)
		...
		PIBSUtils.writeLogInfo(logger, MiscConstant.LOGGING_MESSSAGE_GETDATA_BY_ID);
		    ...
		    Diagnosis model = (Diagnosis) criteriaMap.get(MapConstant.CLASS_DATA);
			 ...
			 try {
				 ...
				 StringBuffer sql = new StringBuffer();				
				 	sql.append("select id,statementofdiagnosis,remarks,dateofdiagnosis,createdby,createdon,modifiedby,modifiedon,version,active ");
				 	sql.append("from pibs.tran_patient_diagnosis ");
				 ...
				 while(rs.next()) {
		    		 ...
		    		 model.setStatementOfDiagnosis(rs.getString(2));
		    		 model.setRemarks(rs.getString(3));
		    		 model.setDateOfDiagnosis(rs.getDate(4));
				 }				 
