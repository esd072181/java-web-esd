...
public class AdmissionDaoImpl implements AdmissionDao {
	...
	public Map<String, Object> save(HashMap<String, Object> dataMap) throws Exception{
		...
		StringBuffer qryLog =  new StringBuffer("insert into pibs.tran_patient_case (");
				...
				qryLog.append(" ,"+model.getAgeAdmitted());
		...
		PIBSUtils.writeLogDebug(logger, "SQL: "+qryLog.toString());
		  ...
		  try {
			  ...
			  pstmt.setInt(9, model.getAgeAdmitted());
			 ...
			 try {
				 ...
				 StringBuffer sql = null;
					sql = new StringBuffer(" select a.id,a.patientid,a.lastname,a.firstname,a.middlename,a.gender,b.listvalue as patientstatus, ");
					    sql.append(" d.listvalue as patienttype,c.caseno,c.chiefcomplaint,e.roomno,f.lastname||', '||f.firstname||' '||f.middlename as doctor,c.dateofcase, h.roomno as roomnotransfer,c.ageadmitted, a.lastname || ', ' || a.firstname || ' ' || a.middlename  as patientfullname ");
...
//					 	sql.append(" and a.patientstatusid = 502 ");//admitted status
				...
				PIBSUtils.writeLogDebug(logger, "SQL: "+sql.toString());
				 ...
				 while(rs.next()) {
		    		 ...
		    		 model.setAgeAdmitted(rs.getInt(15));
		    		 model.setPatientFullName(rs.getString(16));
				 }				 
			 } catch (SQLException e) {
				 throw e;
			 } finally {
		...
		PIBSUtils.writeLogInfo(logger, MiscConstant.LOGGING_MESSSAGE_SEARCH);
		    ...
		    Admission model = (Admission) criteriaMap.get(MapConstant.CLASS_DATA);
			 ...
			 try {
				 ...
				 StringBuffer sql = null;
					sql = new StringBuffer(" select a.id,a.patientid,a.lastname,a.firstname,a.middlename,a.gender,b.listvalue as patientstatus, ");
					    sql.append(" d.listvalue as patienttype,c.caseno,c.chiefcomplaint,e.roomno,f.lastname||', '||f.firstname||' '||f.middlename as doctor,c.dateofcase, c.id as patientcasesystemid, c.ageadmitted ");
		...
		PIBSUtils.writeLogInfo(logger, MiscConstant.LOGGING_MESSSAGE_SEARCH);
		    ...
		    Admission model = (Admission) criteriaMap.get(MapConstant.CLASS_DATA);
			 ...
			 try {
				 ...
				 StringBuffer sql = null;
					sql = new StringBuffer(" select a.id,a.dateofcase,c.rate as roomrate,d.standardadmissionfee as doctorfee, d.lastname || ', ' || d.firstname as doctor, b.roomno, b.id as roomid,a.ageadmitted,c.description as roomcategory");
				...
				PIBSUtils.writeLogDebug(logger, "SQL: "+sql.toString());
				 ...
				 while(rs.next()) {
		    		 ...
		    		 model.setAgeAdmitted(rs.getInt(8));
...
//			PIBSUtils.closeObjects(conn); //do not close here
		...
		PIBSUtils.writeLogInfo(logger, MiscConstant.LOGGING_MESSSAGE_SEARCH);
		    ...
		    Admission model = (Admission) criteriaMap.get(MapConstant.CLASS_DATA);
			 ...
			 try {
				 ...
				 StringBuffer sql = null;
					sql = new StringBuffer(" select a.caseno, b.lastname || ', ' || b.firstname as doctor, c.roomno, a.dateofcase, d.lastname || ', ' || d.firstname || ' ' || d.middlename  as patientfullname, d.patientid, f.roomno as roomnotransfer,a.ageadmitted ");
						sql.append(" from pibs.tran_patient_case a ");  
					 	sql.append(" inner join pibs.file_professional b on a.professionalid = b.id ");
					 	sql.append(" inner join pibs.file_room c on a.roomid = c.id ");
					 	sql.append(" inner join pibs.file_patient_info d  on a.patientsystemid = d.id ");
					 	sql.append(" left join (select * from pibs.tran_patient_room_transfer where active = true order by datetransferred desc limit 1) e on a.id = e.patientcasesystemid ");
					 	sql.append(" left join pibs.file_room f on f.id = e.roomidtransfer ");
				...
				PIBSUtils.writeLogDebug(logger, "SQL: "+sql.toString());
				 ...
				 while(rs.next()) {
		    		 ...
		    		 model.setRoomNoTransfer(rs.getString(7));
		    		 model.setAgeAdmitted(rs.getInt(8));
				 }				 
			 } catch (SQLException e) {
				 throw e;
	...
	@Override
	public Map<String, Object> getDataByPatientSysId(HashMap<String, Object> criteriaMap) throws Exception {
		...
		PIBSUtils.writeLogInfo(logger, MiscConstant.LOGGING_MESSSAGE_SEARCH);
		    ...
		    Admission model = (Admission) criteriaMap.get(MapConstant.CLASS_DATA);
			 ...
			 try {
				 ...
				 StringBuffer sql = null;
					sql = new StringBuffer(" select a.id,a.chiefcomplaint,a.dateofcase,a.datedischarged,d.lastname || ', ' || d.firstname as doctor, b.roomno, a.ageadmitted ");
						sql.append(" from pibs.tran_patient_case a, pibs.file_room b, pibs.file_room_category c, pibs.file_professional d, pibs.file_patient_info e  ");  
					 	sql.append(" where a.roomid = b.id ");
					 	sql.append(" and b.roomcategoryid = c.id ");
					 	sql.append(" and a.professionalid=d.id ");
					 	sql.append(" and a.patientsystemid = e.id ");
					 	sql.append(" and a.patientcasestatusid = 703 ");
					 	sql.append(" and e.id = ?");
				...
				PIBSUtils.writeLogDebug(logger, "SQL: "+sql.toString());
				 ...
				 pstmt.setInt(1, model.getPatientSystemId());
	    ...
	    System.out.println("getDataByPatientSysId() - Exit");
		return returnMap;
	}
