...
public class EmployeeDaoImpl implements EmployeeDao {
	...
	public Map<String, Object> save(HashMap<String, Object> dataMap) throws Exception{
		...
		StringBuffer qryLog =  new StringBuffer("insert into pibs.file_employee (");
				...
				qryLog.append(" ,"+model.getEmpPositionId());
		...
		PIBSUtils.writeLogDebug(logger, "SQL: "+qryLog.toString());
		  ...
		  try {
			  ...
			  pstmt.setInt(5, model.getEmpPositionId());
	...
	public Map<String, Object> update(HashMap<String, Object> dataMap) throws Exception{
		...
		StringBuffer qryLog =  new StringBuffer("update pibs.file_employee set ");	
			...
			qryLog.append(" ,emppositionid="+model.getEmpPositionId());
		...
		PIBSUtils.writeLogInfo(logger, MiscConstant.LOGGING_MESSSAGE_SEARCH);
			 ...
			 try {
				 ...
				 if (category.equals(ActionConstant.SEARCHALL)) {
					 sql = new StringBuffer("select a.id,a.lastname,a.firstname,a.middlename,a.empcategoryid,b.listvalue as empcategory,a.emppositionid,c.listvalue as empposition,a.createdby,a.createdon,a.modifiedby,a.modifiedon,a.version,a.active ");
					 	sql.append(" from pibs.file_employee a, pibs.list_value b, pibs.list_value c ");
					 	sql.append(" where a.empcategoryid = b.id ");
					 	sql.append(" and a.emppositionid = c.id ");
					 ...
					 sql = new StringBuffer("select a.id,a.lastname,a.firstname,a.middlename,a.empcategoryid,b.listvalue as empcategory,a.emppositionid,c.listvalue as empposition,a.createdby,a.createdon,a.modifiedby,a.modifiedon,a.version,a.active ");
					 	...
					 	sql.append(" where a.empcategoryid = b.id ");
					 	sql.append(" and a.emppositionid = c.id ");
					 	sql.append(" and (a.lastname ilike '%"+criteria+"%' or a.firstname ilike '%"+criteria+"%'  or a.middlename ilike '%"+criteria+"%'  or b.listvalue ilike '%"+criteria+"%' or c.listvalue ilike '%"+criteria+"%')" );
					 	sql.append(" and a.active = true ");
					 	sql.append(" order by a.lastname ");
					 	sql.append(" limit ? ");
					 	sql.append(" offset ?");	
				...
				PIBSUtils.writeLogDebug(logger, "SQL: "+sql.toString());
				 ...
				 while(rs.next()) {
		    		 ...
		    		 model.setEmpPositionId(rs.getInt(7));
		    		 model.setEmpPosition(rs.getString(8));
		    		 model.setFullName();
		    		 rsList.add(model);
				 }				 
		     ...
		     try {
			     ...
			     if (category.equals(ActionConstant.SEARCHALL)) {
			    	 ...
			    	 sqlCount = new StringBuffer("select count(*) from pibs.file_employee a, pibs.list_value b, pibs.list_value c where a.empcategoryid = b.id and a.emppositionid = c.id and (a.lastname ilike '%"+criteria+"%' or a.firstname ilike '%"+criteria+"%' or a.middlename ilike '%"+criteria+"%' or b.listvalue ilike '%"+criteria+"%' or c.listvalue ilike '%"+criteria+"%') and a.active = true ");	 
			     } 
		    ...
		    Employee model = (Employee) criteriaMap.get(MapConstant.CLASS_DATA);
			 ...
			 try {
				 ...
				 StringBuffer sql = new StringBuffer();				
				 	sql.append("select a.id,a.lastname,a.firstname,a.middlename,a.empcategoryid,b.listvalue as empcategory,a.emppositionid,c.listvalue as empposition,a.createdby,a.createdon,a.modifiedby,a.modifiedon,a.version,a.active ");
				 	sql.append("from pibs.file_employee a, pibs.list_value b,  pibs.list_value c ");
				 	sql.append("where a.empcategoryid = b.id ");
				 	sql.append("and a.emppositionid = c.id ");
				 	sql.append("and a.id = ?");
				 ...
				 StringBuffer sqlLog = new StringBuffer();				
				 	sqlLog.append("select a.id,a.lastname,a.firstname,a.middlename,a.empcategoryid,b.listvalue as empcategory,a.emppositionid,c.listvalue as empposition,a.createdby,a.createdon,a.modifiedby,a.modifiedon,a.version,a.active ");
				 	sqlLog.append("from pibs.file_employee a, pibs.list_value b,  pibs.list_value c ");
				 	sqlLog.append("where a.empcategoryid = b.id ");
				 	sqlLog.append("and a.emppositionid = c.id ");
	...
	public Map<String, Object> searchForListReport(HashMap<String, Object> criteriaMap) throws Exception {
		...
		PIBSUtils.writeLogInfo(logger, MiscConstant.LOGGING_MESSSAGE_SEARCH);
			 ...
			 try {
				 ...
				 sql = new StringBuffer("select a.id,a.lastname,a.firstname,a.middlename,b.listvalue as category,c.listvalue as position, a.createdby,a.createdon,a.modifiedby,a.modifiedon,a.version,a.active ");
				 	sql.append(" from pibs.file_employee a, pibs.list_value b, pibs.list_value c ");
				 	sql.append(" where a.empcategoryid = b.id ");
				 	sql.append(" and a.emppositionid = c.id ");
				 	sql.append(" and a.active = true ");
			    	...
			    	if (MiscConstant.LOV_EMPLOYEE_REPORT_SEARCH_CRITERIA_POSITION == searchCriteria) {
			    		sql.append(" and c.listvalue ilike '%"+searchValue+"%' ");
			    	}
				 	sql.append(" order by a.lastname ");
				...
				PIBSUtils.writeLogDebug(logger, "SQL: "+sql.toString());
				 ...
				 while(rs.next()) {
		    		 ...
		    		 model.setEmpPosition(rs.getString(6));
			    	 rsList.add(model);
				 }				 
			 } catch (SQLException e) {
				 throw e;
