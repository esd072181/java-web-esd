...
//	}
	...
	public static void storeLOVToSession(HttpServletRequest request) throws Exception{
		...
		for (Object obj: lovTypeList) {
			...
			} else if (listType.getId()==MiscConstant.LOVTYPE_PATIENT_CASE_STATUS_TYPE) {
				//PatientCaseStatus
			...
			} else if (listType.getId()==MiscConstant.LOVTYPE_PATIENT_REPORT_SEARCH_CRITERIA) {
				//Patient Report Search Criteria
				request.getSession().setAttribute(MiscConstant.LOV_PATIENT_REPORT_SEARCH_CRITERIA_SESSION, lovListPerType);	
			} else if (listType.getId()==MiscConstant.LOVTYPE_MEDICAL_SUPPLY_REPORT_SEARCH_CRITERIA) {
				//Medical Supply Search Criteria
				request.getSession().setAttribute(MiscConstant.LOV_MEDICAL_SUPPLY_REPORT_SEARCH_CRITERIA_SESSION, lovListPerType);	
			} else if (listType.getId()==MiscConstant.LOVTYPE_EQUIPMENT_REPORT_SEARCH_CRITERIA) {
				//Equipment Search Criteria
				request.getSession().setAttribute(MiscConstant.LOV_EQUIPMENT_REPORT_SEARCH_CRITERIA_SESSION, lovListPerType);	
			} else if (listType.getId()==MiscConstant.LOVTYPE_LABORATORY_EXAMINATION_REPORT_SEARCH_CRITERIA) {
				//Lab Exam Search Criteria
				request.getSession().setAttribute(MiscConstant.LOV_LABORATORY_EXAMINATION_REPORT_SEARCH_CRITERIA_SESSION, lovListPerType);	
			} else if (listType.getId()==MiscConstant.LOVTYPE_RADIOLOGY_REPORT_SEARCH_CRITERIA) {
				//Radiology Search Criteria
				request.getSession().setAttribute(MiscConstant.LOV_RADIOLOGY_REPORT_SEARCH_CRITERIA_SESSION, lovListPerType);	
			} else if (listType.getId()==MiscConstant.LOVTYPE_SURGERY_REPORT_SEARCH_CRITERIA) {
				//Surgery Search Criteria
				request.getSession().setAttribute(MiscConstant.LOV_SURGERY_REPORT_SEARCH_CRITERIA_SESSION, lovListPerType);	
			} else if (listType.getId()==MiscConstant.LOVTYPE_ADDITIONAL_SERVICES_REPORT_SEARCH_CRITERIA) {
				//Additional Services Search Criteria
				request.getSession().setAttribute(MiscConstant.LOV_ADDITIONAL_SERVICES_REPORT_SEARCH_CRITERIA_SESSION, lovListPerType);	
			} else if (listType.getId()==MiscConstant.LOVTYPE_DISCOUNT_REPORT_SEARCH_CRITERIA) {
				//Discount Search Criteria
				request.getSession().setAttribute(MiscConstant.LOV_DISCOUNT_REPORT_SEARCH_CRITERIA_SESSION, lovListPerType);	
			} else if (listType.getId()==MiscConstant.LOVTYPE_PROFESSIONAL_REPORT_SEARCH_CRITERIA) {
				//Professional Search Criteria
				request.getSession().setAttribute(MiscConstant.LOV_PROFESSIONAL_REPORT_SEARCH_CRITERIA_SESSION, lovListPerType);	
			} else if (listType.getId()==MiscConstant.LOVTYPE_ROOM_REPORT_SEARCH_CRITERIA) {
				//Room Search Criteria
				request.getSession().setAttribute(MiscConstant.LOV_ROOM_REPORT_SEARCH_CRITERIA_SESSION, lovListPerType);	
			} else if (listType.getId()==MiscConstant.LOVTYPE_EMPLOYEE_REPORT_SEARCH_CRITERIA) {
				//Employee Search Criteria
				request.getSession().setAttribute(MiscConstant.LOV_EMPLOYEE_REPORT_SEARCH_CRITERIA_SESSION, lovListPerType);	
			} else if (listType.getId()==MiscConstant.LOVTYPE_NURSERY_REPORT_SEARCH_CRITERIA) {
				//Nursery Search Criteria
				request.getSession().setAttribute(MiscConstant.LOV_NURSERY_REPORT_SEARCH_CRITERIA_SESSION, lovListPerType);	
			} else if (listType.getId()==MiscConstant.LOVTYPE_EMP_POSITION) {
				//EmpPosition
				request.getSession().setAttribute(MiscConstant.LOV_EMPLOYEE_POSITION_SESSION, lovListPerType);	
			}
