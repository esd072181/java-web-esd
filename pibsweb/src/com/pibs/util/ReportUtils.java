...
public class ReportUtils {
	...
	public static boolean generateBillingReport (List<BillingReport> dataList, Map<String, Object> parameters, String localPath, String caseNo) throws Exception{
		...
		try {
			...
			Path serverPath = Paths.get(localPath + File.separator + MiscConstant.FOLDER_PDF_BILLING_REPORT);
			if (!Files.exists(serverPath)) {
				Files.createDirectories(serverPath);
			}
			Path serverCopy = Paths.get(localPath + File.separator + MiscConstant.FOLDER_PDF_BILLING_REPORT + File.separator + MiscConstant.PDF_BILLING_REPORT + caseNo + ".pdf");
