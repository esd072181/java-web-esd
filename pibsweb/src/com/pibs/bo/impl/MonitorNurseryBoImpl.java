...
public class MonitorNurseryBoImpl implements MonitorNurseryBo {
	...
	@Override
	public Map<String, Object> delete(HashMap<String, Object> criteriaMap)
			throws Exception {
		// TODO Auto-generated method stub
		return dao.delete(criteriaMap);
	}
	...
	@Override
	public Map<String, Object> restoreRecord(HashMap<String, Object> criteriaMap)
			throws Exception {
		// TODO Auto-generated method stub
		return dao.restore(criteriaMap);
	}
