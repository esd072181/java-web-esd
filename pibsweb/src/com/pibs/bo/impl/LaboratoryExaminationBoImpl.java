...
public class LaboratoryExaminationBoImpl implements LaboratoryExaminationBo {

	private LaboratoryExaminationDao dao;
	
	public LaboratoryExaminationDao getLaboratoryExaminationDao() {
		return dao;
	}

	public void setLaboratoryExaminationDao(LaboratoryExaminationDao dao) {
		this.dao = dao;
	}
