...
public class RptMedicalSupplyFormBean extends PIBSFormBean {
	...
	private List<ListValue> medSupplyCriteriaLOV;
	...
	public List<ListValue> getMedSupplyCriteriaLOV() {
		return medSupplyCriteriaLOV;
	}

	public void setMedSupplyCriteriaLOV(List<ListValue> medSupplyCriteriaLOV) {
		this.medSupplyCriteriaLOV = medSupplyCriteriaLOV;
	}
	...
	public void populateCriteriaDropdownList(HttpServletRequest request) throws Exception{
    	...
    	if (lovList!=null) {
    		setMedSupplyCriteriaLOV(lovList);
    	}
	}
