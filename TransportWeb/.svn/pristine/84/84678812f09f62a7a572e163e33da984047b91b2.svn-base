...
$(function() {
	...
	<div style="height: 30%; padding-left: 10px;">
		<div style="width: 50%;">
			<h3 style="font-weight: bolder;">Closure on Corrective Actions</h3>
		</div>
		<html:form action="/closure.do" styleId="idForm">
				...
				<div>
					<div>
						...
						<html:button styleId="btnSearchFilter" property="command" onclick="getClosure(1,'filter');" value="Search" styleClass="btn btn-primary"></html:button>
						<html:button property="command" onclick="getClosure(1,'showall');" value="Show All" styleClass="btn btn-primary"></html:button>
						&nbsp;&nbsp;&nbsp;&nbsp;<html:button property="command" onclick="goToAddClosure();" value="Add New Record" styleClass="btn btn-primary"></html:button>
	...
	<!-- using bootstrap -->
	<div id="tablePresentationDIV" style="padding-left: 10px;">
