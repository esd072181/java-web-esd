...
<div style="padding-left: 10px;">
		...
		<div style="height: 30%;">
			<h3 style="font-weight: bolder;">Driver Incident - Add New Record</h3>
							 	 ...
							 	 <div class="controls">
									<c:choose>  
										<c:when test="${driverIncidentForm.transactionStatus == true}">
											<html:button property="btnAddNew" styleClass="btn btn-primary" onclick="goToAddDriverIncident();" value="Add New Record"></html:button>
											<html:button property="btnClose" styleClass="btn btn-primary" onclick="goToDriverIncident();" value="Close"></html:button>
										</c:when>
										<c:otherwise>
											<html:button property="btnSave" styleClass="btn btn-primary" onclick="saveDriverIncident();" value="Save"></html:button>
