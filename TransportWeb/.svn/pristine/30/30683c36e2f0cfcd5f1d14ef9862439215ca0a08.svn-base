...
public class DriverTrainingProfileCommentsIncidentBoImpl implements DriverTrainingProfileCommentsBo {

	private DriverTrainingProfileCommentsDao dao;
	
	public DriverTrainingProfileCommentsDao getDriverTrainingProfileCommentsIncidentDao() {
		return dao;
	}

	public void setDriverTrainingProfileCommentsIncidentDao(DriverTrainingProfileCommentsDao dao) {
		this.dao = dao;
	}
