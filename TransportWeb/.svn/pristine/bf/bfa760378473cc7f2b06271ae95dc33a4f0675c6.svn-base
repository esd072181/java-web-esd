...
public class DriverTrainingProfileBoImpl implements DriverTrainingProfileBo {

	private DriverTrainingProfileDao dao;
	
	public DriverTrainingProfileDao getDriverTrainingProfileDao() {
		return dao;
	}

	public void setDriverTrainingProfileDao(DriverTrainingProfileDao dao) {
		this.dao = dao;
	}
