 ...
 * @since 21Aug2016
 */
public class TireBrandModule implements TransportModule {
	
	private final static Logger logger = Logger.getLogger(TireBrandModule.class);
	...
	public Map<String, Object> executeRequest(HashMap<String, Object> dataMap)
		...
		try {
			...
			TireBrandBo bo = (TireBrandBo) dataMap.get(MapConstant.BEAN);
