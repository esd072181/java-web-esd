...
public class ItemsFormBean extends TransportFormBean {
	...
	public void populateFormBean(Items model) {
		setId(model.getId());
		setDescription(model.getDescription());
	}
	
	public Items populateModel (ItemsFormBean formbean) {
