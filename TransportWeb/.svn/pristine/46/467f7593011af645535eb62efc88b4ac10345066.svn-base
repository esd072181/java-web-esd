...
import com.transport.bo.ItemsBo;
import com.transport.constant.ActionConstant;
import com.transport.constant.MapConstant;
import com.transport.util.TransportUtils;

public class ItemsModule implements TransportModule {
	
	private final static Logger logger = Logger.getLogger(ItemsModule.class);
	...
	public Map<String, Object> executeRequest(HashMap<String, Object> dataMap)
		...
		try {
			...
			ItemsBo bo = (ItemsBo) dataMap.get(MapConstant.BEAN);
