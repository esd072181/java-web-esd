...
public class RootCauseModule implements TransportModule {
	
	private final static Logger logger = Logger.getLogger(RootCauseModule.class);
	...
	public Map<String, Object> executeRequest(HashMap<String, Object> dataMap)
		...
		try {
			...
			RootCauseBo bo = (RootCauseBo) dataMap.get(MapConstant.BEAN);
