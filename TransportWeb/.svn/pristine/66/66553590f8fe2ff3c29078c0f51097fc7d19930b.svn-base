...
<div style="height: 30%; padding-left: 10px;">
		<div style="width: 50%;">
			<h3 style="font-weight: bolder;">Corrective Actions</h3>
		</div>
		<html:form action="/corrections.do" styleId="idForm">
				...
				<div>
					<div>
						...
						<html:button styleId="btnSearchFilter" property="command" onclick="getCorrections(1,'filter');" value="Search" styleClass="btn btn-primary"></html:button>
						<html:button property="command" onclick="getCorrections(1,'showall');" value="Show All" styleClass="btn btn-primary"></html:button>
						&nbsp;&nbsp;&nbsp;&nbsp;<html:button property="command" onclick="goToAddCorrections();" value="Add New Record" styleClass="btn btn-primary"></html:button>
