...
public class WorkPermitBoImpl implements WorkPermitBo {

	private WorkPermitDao dao;
	
	public WorkPermitDao getWorkPermitDao() {
		return dao;
	}

	public void setWorkPermitDao(WorkPermitDao dao) {
		this.dao = dao;
	}
