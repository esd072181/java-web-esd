...
import com.transport.bo.RemarksBo;
import com.transport.constant.ActionConstant;
import com.transport.constant.MapConstant;
import com.transport.util.TransportUtils;

public class RemarksModule implements TransportModule {
	
	private final static Logger logger = Logger.getLogger(RemarksModule.class);
	...
	public Map<String, Object> executeRequest(HashMap<String, Object> dataMap)
		...
		try {
			...
			RemarksBo bo = (RemarksBo) dataMap.get(MapConstant.BEAN);
