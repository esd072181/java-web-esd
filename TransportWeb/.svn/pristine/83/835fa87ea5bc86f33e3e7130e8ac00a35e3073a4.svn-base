...
import com.transport.bo.RootCauseBo;
import com.transport.dao.RootCauseDao;

public class RootCauseBoImpl implements RootCauseBo {

	private RootCauseDao dao;
	
	public RootCauseDao getRootCauseDao() {
		return dao;
	}

	public void setRootCauseDao(RootCauseDao dao) {
		this.dao = dao;
	}
