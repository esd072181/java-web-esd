...
<div style="height: 30%; padding-left: 10px;">
		<h3 style="font-weight: bolder;">Work Permit Report</h3>
		...
		<html:form action="/rptWorkPermit.do" styleId="idForm">
				<div>
					<html:errors/>
				</div>
				<div>
					<div>
						<table>
							<tr>
								<td><label  class="control-label top-spacing" for="transportId">Transport:</label></td>
								<td>
									<html:select  name="rptWorkPermitForm" property="transportId">
								 		<html:optionsCollection name="rptWorkPermitForm" property="transportProgramLOV" label="listValue" value="id"/>				 		
							 		</html:select>	
								</td>
							</tr>
							<tr>
								...
								<td>
									<html:select  name="rptWorkPermitForm" property="searchCriteria" styleId="searchCriteriaId" onchange="showDateCriteria(this.value);" >
										<html:optionsCollection name="rptWorkPermitForm" property="workPermitCriteriaLOV" label="listValue" value="id"/>				 		
									</html:select>									
								</td>
							</tr>
							<tr>
							...
							<tr>
								<td colspan="5"><label  class="top-spacing"><span style="font-size:x-small;">(Note: Date From and Date To are used only for Date Started and Date Ended search criteria.)</span></label></td>
							</tr>
							<tr>
						...
						<div class="control-group">
							...
							<div class="controls">
								<html:button styleId="btnSearchFilter"  property="command" onclick="getRptWorkPermit();" value="Search and Generate Report" styleClass="btn btn-primary"></html:button>
							</div>
						</div>						
					</div>
				</div>			
