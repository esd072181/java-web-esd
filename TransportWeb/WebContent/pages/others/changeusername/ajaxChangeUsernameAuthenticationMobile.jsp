...
<div>
	...
	<div align="left">
		...
		<hr>
		<br>
		<h4 style="font-weight: bolder; font-size: 30px; color: blue;">Please enter your CURRENT username and password</h4>
	</div>
	...
	<div>
		<html:form action="/checkUsernameMobile.do" styleId="idForm" >
			<table>
				<tr>
	...
	<div class="control-group" align="center">
		<div class="controls">
			<c:choose>
				...
				<c:otherwise>
					<html:button property="btnUpdate" styleClass="btn btn-primary" style="font-size: 34px;" onclick="checkChangeUsernameMobile();" value="Submit"></html:button>&nbsp;&nbsp;&nbsp;&nbsp;
