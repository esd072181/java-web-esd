...
<div class="row">
 	...
 	<div class="col-sm-10">
		...
		<h3 style="font-weight: bolder;">Change Username and Password - Authentication</h3>
		<h4 style="font-weight: bolder;">Please enter your CURRENT username and password below:</h4>
			<html:form action="/checkUsername.do" styleId="idForm" >
				<fieldset>
							 ...
							 <div class="control-group">
							 	 <div class="controls">
									<c:choose>
										...
										<c:otherwise>
											<html:button property="btnUpdate" styleClass="btn btn-primary" onclick="checkChangeUsername();" value="Submit"></html:button>
