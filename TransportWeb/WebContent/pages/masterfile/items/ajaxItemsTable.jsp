		...
		<c:choose>
		  <c:when test="${itemsForm.modelList != null}">
			<table  class="table table-bordered table-striped table-condensed table-hover" style="width: 98%;">  
				...
				<logic:iterate name="itemsForm" property="modelList" type="com.transport.model.Items" id="model" indexId="index">
					<tr>				 
						<td><c:out value="${index+1 + (itemsForm.currentPage * 10 - 10)}"/></td>
