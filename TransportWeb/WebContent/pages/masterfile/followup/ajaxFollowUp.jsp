...
<div style="height: 30%; padding-left: 10px;">
		<div style="width: 50%;">
			<h3 style="font-weight: bolder;">Follow Up</h3>
		</div>
		<html:form action="/followUp.do" styleId="idForm">
				...
				<div>
					<div>
						...
						<html:button styleId="btnSearchFilter" property="command" onclick="getFollowUp(1,'filter');" value="Search" styleClass="btn btn-primary"></html:button>
						<html:button property="command" onclick="getFollowUp(1,'showall');" value="Show All" styleClass="btn btn-primary"></html:button>
						&nbsp;&nbsp;&nbsp;&nbsp;<html:button property="command" onclick="goToAddFollowUp();" value="Add New Record" styleClass="btn btn-primary"></html:button>
