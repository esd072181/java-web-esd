...
<html>
	<body>
		...
		<form action="/updateMaintenanceMonitoringPreventive" name="maintenanceMonitoringForm" id="idPopupForm">
			...
			<table>
					<tr>
						<td colspan="2"><h2>PREVENTIVE GARAGE</h2></td>
					</tr>
					<tr>
					<tr>
					...
					<tr>
						<td valign="top"><label>Garage</label></td>
						<td>
						...
						<td>
							<c:forEach items="${sessionScope.user_access_list}" var="item">
	        					<c:if test="${item == 925 && sessionScope.isEditStatusLocked == 'N'}">
	        						...
	        						<input type="button" style="margin-left: 313px;" name="updateBtn" value="Update" onclick="updateMaintenanceMonitoring('2431');" />
	        					</c:if>
	        				</c:forEach>
						</td>
					</tr>
