							 	 ...
							 	 <div class="controls">
									<c:choose>  
										<c:when test="${maintenanceInspectionForm.transactionStatus == true}">
											<html:button property="btnAddNew" styleClass="btn btn-primary" onclick="goToAddMaintenanceInspection();" value="Add New Record"></html:button>
											<html:button property="btnClose" styleClass="btn btn-primary" onclick="goToMaintenanceInspection();" value="Close"></html:button>
										</c:when>
										<c:otherwise>
											<html:button property="btnSave" styleClass="btn btn-primary" onclick="saveMaintenanceInspection();" value="Save"></html:button>
