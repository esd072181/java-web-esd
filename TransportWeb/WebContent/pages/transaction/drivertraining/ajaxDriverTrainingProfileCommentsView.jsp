...
<div style="height: 30%; padding-left: 10px;">
		<h3 style="font-weight: bolder;">Driver Training Profile Comments</h3>
			<table>
				...
				<tr>
					<td>
						<html:button property="command" onclick="viewDriverTrainingSummary('${driverTrainingForm.driverTrainingId}','${driverTrainingForm.driverName}');" value="Go Back" styleClass="btn btn-primary"></html:button>
					</td>
				</tr>
				<tr style="height: 10px;"></tr>
				<tr>
