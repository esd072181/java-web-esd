...
<div style="height: 30%; padding-left: 10px;">
			<h3 style="font-weight: bolder;">Driver Training Info - Add New Record</h3>
							 	 ...
							 	 <div class="controls">
									<c:choose>  
										<c:when test="${driverTrainingForm.transactionStatus == true}">
											<html:button property="btnAddNew" styleClass="btn btn-primary" onclick="goToAddDriverTrainingInfo('${driverTrainingForm.driverTrainingId}','${driverTrainingForm.driverName}');" value="Add New Record"></html:button>
										...
										<c:otherwise>
											<html:button property="btnSave" styleClass="btn btn-primary" onclick="saveDriverTrainingInfo('${driverTrainingForm.driverTrainingId}','${driverTrainingForm.driverName}');" value="Save"></html:button>
