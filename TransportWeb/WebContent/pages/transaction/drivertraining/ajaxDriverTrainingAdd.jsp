                            	...
                            	<table>
								 	...
								 	<tr>
                                        ...
                                        <c:choose>
                                        	<c:when test="${driverTrainingForm.transactionStatus == false}">
                                        		<td style="padding-left: 5px;"><input type="file" name="file" style="width: 180px;" ></td>
                                        	</c:when>
                                        	<c:otherwise>
                                        	      <c:choose>
								    ...
								    <tr>
                                    	...
                                    	<td style="padding-left: 10px;">Religion</td>
                                         <td style="padding-left: 5px;">
                                        	<html:select style="width: 180px; height: 22px;"  name="driverTrainingForm" property="religion" value="Catholic" disabled="${driverTrainingForm.transactionStatus}">
                                    ...
                                    <tr>
                                    	...
                                    	<td style="padding-left: 5px;">
                                        	<html:select style="width: 180px; height: 22px;"  name="driverTrainingForm" property="civilStatus" value="Married" disabled="${driverTrainingForm.transactionStatus}">
