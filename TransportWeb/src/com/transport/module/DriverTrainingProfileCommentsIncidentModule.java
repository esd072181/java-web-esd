 ...
 * @since 16Sep2019
 */
public class DriverTrainingProfileCommentsIncidentModule implements TransportModule {
	
	private final static Logger logger = Logger.getLogger(DriverTrainingProfileCommentsIncidentModule.class);
