...
import com.transport.bo.LorryBo;
import com.transport.constant.ActionConstant;
import com.transport.constant.MapConstant;
import com.transport.util.TransportUtils;

public class LorryModule implements TransportModule {
	
	private final static Logger logger = Logger.getLogger(LorryModule.class);
	...
	public Map<String, Object> executeRequest(HashMap<String, Object> dataMap)
		...
		try {
			...
			LorryBo bo = (LorryBo) dataMap.get(MapConstant.BEAN);
