...
public class DriverTrainingInfoModule implements TransportModule {
	
	private final static Logger logger = Logger.getLogger(DriverTrainingInfoModule.class);
	...
	public Map<String, Object> executeRequest(HashMap<String, Object> dataMap)
		...
		try {
			...
			DriverTrainingInfoBo bo = (DriverTrainingInfoBo) dataMap.get(MapConstant.BEAN);
