...
import com.transport.bo.TerminalBo;
import com.transport.constant.ActionConstant;
import com.transport.constant.MapConstant;
import com.transport.util.TransportUtils;

public class TerminalModule implements TransportModule {
	
	private final static Logger logger = Logger.getLogger(TerminalModule.class);
	...
	public Map<String, Object> executeRequest(HashMap<String, Object> dataMap)
		...
		try {
			...
			TerminalBo bo = (TerminalBo) dataMap.get(MapConstant.BEAN);
