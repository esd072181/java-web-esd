 ...
 * @since 16Sep2019
 */
public class DriverTrainingProfileCommentsIncabModule implements TransportModule {
	
	private final static Logger logger = Logger.getLogger(DriverTrainingProfileCommentsIncabModule.class);
