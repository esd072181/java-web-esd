...
public class DriverTrainingModule implements TransportModule {
	
	private final static Logger logger = Logger.getLogger(DriverTrainingModule.class);
	...
	public Map<String, Object> executeRequest(HashMap<String, Object> dataMap)
		...
		try {
			...
			DriverTrainingBo bo = (DriverTrainingBo) dataMap.get(MapConstant.BEAN);
			...
			switch(action) {
				...
				case ActionConstant.RESTORE: returnMap = bo.restoreRecord(dataMap);
						break;
				case ActionConstant.GET_DATA_BY_CRITERIA: returnMap = bo.getDataByDriverId(dataMap);
						break;
