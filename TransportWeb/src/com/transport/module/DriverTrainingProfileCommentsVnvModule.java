 ...
 * @since 15Sep2019
 */
public class DriverTrainingProfileCommentsVnvModule implements TransportModule {
	
	private final static Logger logger = Logger.getLogger(DriverTrainingProfileCommentsVnvModule.class);
