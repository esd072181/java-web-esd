...
import com.transport.bo.EmployeeBo;
import com.transport.constant.ActionConstant;
import com.transport.constant.MapConstant;
import com.transport.util.TransportUtils;

public class EmployeeModule implements TransportModule {
	
	private final static Logger logger = Logger.getLogger(EmployeeModule.class);
	...
	public Map<String, Object> executeRequest(HashMap<String, Object> dataMap)
		...
		try {
			...
			EmployeeBo bo = (EmployeeBo) dataMap.get(MapConstant.BEAN);
			...
			switch(action) {
				...
				case ActionConstant.GET_ACTIVE_DATA: returnMap = bo.getActiveData();
						break;
				case ActionConstant.GET_NO_USER_ACCOUNT_DATA: returnMap = bo.getNoUserAccountData();
						break;
