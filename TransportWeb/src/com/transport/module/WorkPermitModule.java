...
import com.transport.bo.WorkPermitBo;
import com.transport.constant.ActionConstant;
import com.transport.constant.MapConstant;
import com.transport.util.TransportUtils;

public class WorkPermitModule implements TransportModule {
	
	private final static Logger logger = Logger.getLogger(WorkPermitModule.class);
	...
	public Map<String, Object> executeRequest(HashMap<String, Object> dataMap)
		...
		try {
			...
			WorkPermitBo bo = (WorkPermitBo) dataMap.get(MapConstant.BEAN);
