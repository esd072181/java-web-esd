...
import com.transport.bo.DriverTrainingProfileBo;
import com.transport.constant.ActionConstant;
import com.transport.constant.MapConstant;
import com.transport.util.TransportUtils;

public class DriverTrainingProfileModule implements TransportModule {
	
	private final static Logger logger = Logger.getLogger(DriverTrainingProfileModule.class);
	...
	public Map<String, Object> executeRequest(HashMap<String, Object> dataMap)
		...
		try {
			...
			DriverTrainingProfileBo bo = (DriverTrainingProfileBo) dataMap.get(MapConstant.BEAN);
			...
			switch(action) {
				...
				case ActionConstant.RESTORE: returnMap = bo.restoreRecord(dataMap);
						break;
				case ActionConstant.GET_DATA_BY_CRITERIA: returnMap = bo.getDataByDriverTrainingId(dataMap);
						break;
				default: break;
			};	
		}catch (Exception e) {
