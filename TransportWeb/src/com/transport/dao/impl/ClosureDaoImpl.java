...
import com.transport.dao.ClosureDao;
...
public class ClosureDaoImpl implements ClosureDao {
	...
	private final static Logger logger = Logger.getLogger(ClosureDaoImpl.class);
	...
	public Map<String, Object> save(HashMap<String, Object> dataMap) throws Exception{
		...
		Closure model = (Closure) dataMap.get(MapConstant.CLASS_DATA);
		...
		StringBuffer qry =  new StringBuffer("insert into transport.file_closure (");
		...
		StringBuffer qryLog =  new StringBuffer("insert into transport.file_closure (");
		...
		TransportUtils.writeLogDebug(logger, "SQL: "+qryLog.toString());
		  ...
		  try {
			  ...
			  pstmt.setInt(1, model.getCorrectionsId());
			  ...
			  if (statusInt == 1) {
				  conn.commit();
				  System.out.println("Inserted into Closure table successfully..");
				  status = true;
			  }
		  } catch (Exception e) {
			  conn.rollback();
	...
	public Map<String, Object> update(HashMap<String, Object> dataMap) throws Exception{
		...
		StringBuffer qry =  new StringBuffer("update transport.file_closure set ");	
			qry.append(" correctionsid=? ");
			qry.append(" ,description=? ");
		...
		StringBuffer qryLog =  new StringBuffer("update transport.file_closure set ");	
		...
		TransportUtils.writeLogDebug(logger, "SQL: "+qryLog.toString());
		 ...
		 try {
			...
			if (statusInt == 1) {
				conn.commit();
				System.out.println("Closure record (id: " +model.getId()+") updated successfully..");
				status = true;
			}
		} catch (Exception e) {
			conn.rollback();
	...
	public Map<String, Object> delete(HashMap<String, Object> dataMap) throws Exception{
		...
		TransportUtils.writeLogDebug(logger, "SQL: "+qryLog.toString());
		 ...
		 try {
			...
			if (statusInt == 1) {
				conn.commit();
				System.out.println("Closure record (id: " +model.getId()+") deleted successfully..");
				status = true;
			}
		} catch (Exception e) {
			conn.rollback();
	...
	public Map<String, Object> search(HashMap<String, Object> criteriaMap) throws Exception{
		...
		TransportUtils.writeLogInfo(logger, MiscConstant.LOGGING_MESSSAGE_SEARCH);
			 ...
			 PreparedStatement pstmt = null;
			  ...
			  List<Closure> rsList = new ArrayList<Closure>();
			 ...
			 try {
				 ...
				 if (category.equals(ActionConstant.SEARCHALL)) {
					 sql = new StringBuffer("select a.id,a.description,b.description as corrections,a.createdby,a.createdon,a.modifiedby,a.modifiedon,a.version,a.active ");
					 	sql.append(" from transport.file_closure a, transport.file_corrections b ");
					 	sql.append(" where a.correctionsid = b.id ");
				...
				if (category.equals(ActionConstant.SEARCHALL)) {
							 sqlLog = new StringBuffer("select a.id,a.description,b.description as corrections,a.createdby,a.createdon,a.modifiedby,a.modifiedon,a.version,a.active ");
							 sqlLog.append(" from transport.file_closure a, transport.file_corrections b ");
							 sqlLog.append(" where a.correctionsid = b.id ");
				...
				TransportUtils.writeLogDebug(logger, "SQL: "+sqlLog.toString());
				 ...
				 while(rs.next()) {
		    		 ...
		    		 model.setCorrections(rs.getString(3));
		    		 rsList.add(model);
				 }				 
		     ...
		     try {
			     ...
			     if (category.equals(ActionConstant.SEARCHALL)) {
			    	 sqlCount = new StringBuffer("select count(*) from transport.file_closure where active = true");	 
			     }else {
			    	 sqlCount = new StringBuffer("select count(*) from transport.file_closure where  (description ilike '%"+criteria+"%') and active = true");	 
			     } 

				StringBuffer sqlCountLog = null;
				if (category.equals(ActionConstant.SEARCHALL)) {
					 sqlCountLog = new StringBuffer("select count(*) from transport.file_closure where active = true");	 
				}else {
					 sqlCountLog = new StringBuffer("select count(*) from transport.file_closure where  (description ilike '%"+criteria+"%') and active = true");	 
				} 
	...
	public Map<String, Object> getDataById(HashMap<String, Object> criteriaMap)
		...
		TransportUtils.writeLogInfo(logger, MiscConstant.LOGGING_MESSSAGE_GETDATA_BY_ID);
		    ...
		    Closure model = (Closure) criteriaMap.get(MapConstant.CLASS_DATA);
			 ...
			 try {
				 ...
				 StringBuffer sql = new StringBuffer();				
				 	sql.append("select a.id,a.description,b.description as corrections,b.id as correctionsid,a.createdby,a.createdon,a.modifiedby,a.modifiedon,a.version,a.active ");
				 	sql.append("from transport.file_closure a, transport.file_corrections b ");
				 	sql.append("where a.correctionsid = b.id ");
				 	sql.append("and a.id = ?");

				 StringBuffer sqlLog = new StringBuffer();				
				 	sqlLog.append("select a.id,a.description,b.description as corrections,b.id as correctionsid,a.createdby,a.createdon,a.modifiedby,a.modifiedon,a.version,a.active ");
				 	sqlLog.append("from transport.file_closure a, transport.file_corrections b ");
				 	sqlLog.append("where a.correctionsid = b.id ");
				 ...
				 while(rs.next()) {
		    		 ...
		    		 model.setDescription(rs.getString(2));
		    		 model.setCorrections(rs.getString(3));
		    		 model.setCorrectionsId(rs.getInt(4));
				 }				 
			 } catch (SQLException e) {
				 throw e;
			 } finally {
	...
	public Map<String, Object> getActiveData() throws Exception {
		...
		TransportUtils.writeLogInfo(logger, MiscConstant.LOGGING_MESSSAGE_GET_ACTIVE_DATA);
			 ...
			 try {
				 ...
				 StringBuffer sql = new StringBuffer();				
				 	sql.append("select a.id,a.description,b.description as corrections,a.createdby,a.createdon,a.modifiedby,a.modifiedon,a.version,a.active ");
				 	sql.append("from transport.file_closure a, transport.file_corrections b ");
				 	sql.append("where a.correctionsid = b.id ");
				 	sql.append("and a.active = true ");
				 	sql.append("order by a.description");
				 ...
				 StringBuffer sqlLog = new StringBuffer();				
				 	sqlLog.append("select a.id,a.description,b.description as corrections,a.createdby,a.createdon,a.modifiedby,a.modifiedon,a.version,a.active ");
				 	sqlLog.append("from transport.file_closure a, transport.file_corrections b ");
				 	sqlLog.append("where a.correctionsid = b.id ");
				 	sqlLog.append("and a.active = true ");
				 	sqlLog.append("order by a.description");
		...
		TransportUtils.writeLogInfo(logger, MiscConstant.LOGGING_MESSSAGE_GET_INACTIVE_DATA);
		 ...
		 int limit = (int) criteriaMap.get(MapConstant.PAGINATION_LIMIT);
		     ...
		     try {
			    ...
			    sqlCount = new StringBuffer("select count(*) from transport.file_closure where active = false");	 

				StringBuffer sqlCountLog = null;
				sqlCountLog = new StringBuffer("select count(*) from transport.file_closure where active = false");	 
	...
	public Map<String, Object> restore(HashMap<String, Object> dataMap) throws Exception{
		...
		TransportUtils.writeLogDebug(logger, "SQL: "+qryLog.toString());
		 ...
		 try {
			...
			if (statusInt == 1) {
				conn.commit();
				System.out.println("Closure record (id: " +model.getId()+") restored successfully..");
				status = true;
			}
		} catch (Exception e) {
			conn.rollback();
	...
	@Override
	public Map<String, Object> getClosureByCorrections(HashMap<String, Object> criteriaMap) throws Exception {
		// TODO Auto-generated method stub
		TransportUtils.writeLogInfo(logger, MiscConstant.LOGGING_MESSSAGE_GET_ACTIVE_DATA);
			 ...
			 try {
				 ...
				 StringBuffer sql = new StringBuffer();				
				 	...
				 	sql.append("where a.correctionsid = b.id ");
				 	sql.append("and a.active = true ");
				 	sql.append("and a.correctionsid = ? ");
				 	sql.append("order by a.description");
				 ...
				 StringBuffer sqlLog = new StringBuffer();				
				 	...
				 	sqlLog.append("where a.correctionsid = b.id ");
				 	sqlLog.append("and a.active = true ");
				 	sqlLog.append("and a.correctionsid = " + entityId + " ");
				 	sqlLog.append("order by a.description");
