...
import com.transport.dao.UserAccessDao;
...
public class UserAccessDaoImpl implements UserAccessDao {
	...
	public Map<String, Object> save(HashMap<String, Object> dataMap) throws Exception{
		...
		StringBuffer qry =  new StringBuffer("insert into transport.file_user_access (");
		  		qry.append("userid ");
		  		qry.append(",accessid ");
		...
		StringBuffer qryLog =  new StringBuffer("insert into transport.file_user_access (");
	...
	public Map<String, Object> delete(HashMap<String, Object> dataMap) throws Exception{
		...
		StringBuffer qry =  new StringBuffer("update transport.file_user_access set ");	
		...
		StringBuffer qryLog =  new StringBuffer("update transport.file_user_access set ");	
	...
	public Map<String, Object> search(HashMap<String, Object> criteriaMap)
			throws Exception {
		// TODO Auto-generated method stub
		TransportUtils.writeLogInfo(logger, MiscConstant.LOGGING_MESSSAGE_GETDATA_BY_USER_ID);
		    ...
		    List<UserAccess> modelList = new ArrayList<>();
			 ...
			 try {
				 ...
				 StringBuffer sql = new StringBuffer();				
				 	...
				 	sql.append(" from transport.file_user_access a, transport.list_value b ");
				 ...
				 StringBuffer sqlLog = new StringBuffer();				
				 	...
				 	sqlLog.append(" from transport.file_user_access a, transport.list_value b ");
		     ...
		     try {
		    	 ...
		    	 sqlCount.append(" from transport.file_user_access a, transport.list_value b ");
	...
	public  Map<String, Object> isAccessExistsForUser(HashMap<String, Object> criteriaMap) throws Exception {
		 ...
		 try {
			 ...
			 StringBuffer sql = new StringBuffer();				
			 	sql.append("select a.* from transport.file_user_access a");
