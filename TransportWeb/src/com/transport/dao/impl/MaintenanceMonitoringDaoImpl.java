			...
			if (moduleInnerId == ModuleConstant.MAINTENANCE_MONITORING_GPS) {
				...
				switch (model.getDay()) {
					...
					case 6: 
						...
						pstmt.setInt(3, model.getMaintenanceCategory6());
						pstmt.setString(4, model.getMaintenanceRemarks6());
						pstmt.setInt(5, model.getAvailableVolume6());
						break;
					case 7: 
					...
					case 19: 
						...
						pstmt.setInt(3, model.getMaintenanceCategory19());
						pstmt.setString(4, model.getMaintenanceRemarks19());
						pstmt.setInt(5, model.getAvailableVolume19());
						break;
					case 20: 
