...
import com.transport.module.DriverIncidentModule;
import com.transport.module.DriverTrainingInfoModule;
import com.transport.module.DriverTrainingModule;
import com.transport.module.DriverTrainingProfileCommentsIncabModule;
import com.transport.module.DriverTrainingProfileCommentsIncidentModule;
import com.transport.module.DriverTrainingProfileCommentsSpotcheckModule;
import com.transport.module.DriverTrainingProfileCommentsVnvModule;
...
import com.transport.module.MaintenanceMonitoringSecurityModule;
		...
		try {
			...
			switch(moduleId) {
				...
				case ModuleConstant.MAINTENANCE_MONITORING_PREVENTIVE ://Inner Module
					...
					returnMap = module.executeRequest(dataMap);
					break;
				case ModuleConstant.MAINTENANCE_MONITORING_TOTAL_PENDING ://Inner Module
					module = new MaintenanceMonitoringTotalPendingModule();
					returnMap = module.executeRequest(dataMap);
					break;
				case ModuleConstant.MAINTENANCE_MONITORING_SECURITY ://Inner Module
					module = new MaintenanceMonitoringSecurityModule();
					returnMap = module.executeRequest(dataMap);
					break;
				case ModuleConstant.DRIVER_TRAINING :
					...
					returnMap = module.executeRequest(dataMap);
					break;
				case ModuleConstant.DRIVER_TRAINING_INFO : //Inner Module
					module = new DriverTrainingInfoModule();
					returnMap = module.executeRequest(dataMap);
					break;
				case ModuleConstant.DRIVER_TRAINING_PROFILE : //Inner Module
					module = new DriverTrainingProfileModule();
					returnMap = module.executeRequest(dataMap);
					break;
				case ModuleConstant.DRIVER_TRAINING_PROFILE_COMMENTS_VNV : //Inner Module
					module = new DriverTrainingProfileCommentsVnvModule();
					returnMap = module.executeRequest(dataMap);
					break;
				case ModuleConstant.DRIVER_TRAINING_PROFILE_COMMENTS_INCAB : //Inner Module
					module = new DriverTrainingProfileCommentsIncabModule();
					returnMap = module.executeRequest(dataMap);
					break;
				case ModuleConstant.DRIVER_TRAINING_PROFILE_COMMENTS_SPOTCHECK : //Inner Module
					module = new DriverTrainingProfileCommentsSpotcheckModule();
					returnMap = module.executeRequest(dataMap);
					break;
				case ModuleConstant.DRIVER_TRAINING_PROFILE_COMMENTS_INCIDENT : //Inner Module
					module = new DriverTrainingProfileCommentsIncidentModule();
					returnMap = module.executeRequest(dataMap);
					break;
