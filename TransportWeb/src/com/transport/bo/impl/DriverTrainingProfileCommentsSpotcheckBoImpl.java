...
public class DriverTrainingProfileCommentsSpotcheckBoImpl implements DriverTrainingProfileCommentsBo {

	private DriverTrainingProfileCommentsDao dao;
	
	public DriverTrainingProfileCommentsDao getDriverTrainingProfileCommentsSpotcheckDao() {
		return dao;
	}

	public void setDriverTrainingProfileCommentsSpotcheckDao(DriverTrainingProfileCommentsDao dao) {
		this.dao = dao;
	}
