...
public class FindingsBoImpl implements FindingsBo {

	private FindingsDao dao;
	
	public FindingsDao getFindingsDao() {
		return dao;
	}

	public void setFindingsDao(FindingsDao dao) {
		this.dao = dao;
	}
	...
	public Map<String, Object> getFindingsByItem(HashMap<String, Object> criteriaMap) throws Exception {
		// TODO Auto-generated method stub
		return dao.getFindingsByItem(criteriaMap);
	}
