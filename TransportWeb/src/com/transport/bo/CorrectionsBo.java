...
public interface CorrectionsBo {
	...
	Map<String, Object> getNoClosureData() throws Exception;
	Map<String, Object> getCorrectionsByRootCause(HashMap<String, Object> criteriaMap) throws Exception;
}
