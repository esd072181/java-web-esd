...
public class FollowUpFormBean extends TransportFormBean {
	...
	private List<FollowUp> modelList;
	
	private boolean transactionStatus;
	private String transactionMessage;
	
	public FollowUpFormBean() {}
	...
	public List<FollowUp> getModelList() {
		return modelList;
	}

	public void setModelList(List<FollowUp> modelList) {
	...
	public void populateFormBean(FollowUp model) {
		setId(model.getId());
		setDescription(model.getDescription());
	}
	
	public FollowUp populateModel (FollowUpFormBean formbean) {
