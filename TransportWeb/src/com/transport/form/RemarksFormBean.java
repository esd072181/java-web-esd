...
public class RemarksFormBean extends TransportFormBean {
	...
	private List<Remarks> modelList;
	
	private boolean transactionStatus;
	private String transactionMessage;
	
	public RemarksFormBean() {}
	...
	public List<Remarks> getModelList() {
		return modelList;
	}

	public void setModelList(List<Remarks> modelList) {
	...
	public void populateFormBean(Remarks model) {
		setId(model.getId());
		setDescription(model.getDescription());
	}
	
	public Remarks populateModel (RemarksFormBean formbean) {
