...
<body>
	...
	<div style="width: 100%;">
		...
		<form:form action="/crmsweb/updateProfessional" method="post" modelAttribute="professional"  cssClass="form-horizontal">
						...
						<div class="form-group">
							...
							<c:choose>
								<c:when test="${isSuccess == true}">
									<input class="btn btn-default" type="button" value="Close" onclick="window.location.href = '/crmsweb/goToSearchProfessional';">
								</c:when>
								<c:otherwise>
									<input class="btn btn-default" type="submit" value="Submit/Update">
									<input class="btn btn-default" type="button" value="Cancel" onclick="window.location.href = '/crmsweb/goToSearchProfessional';">
								</c:otherwise>
							</c:choose>
							</div>
						</div>					
