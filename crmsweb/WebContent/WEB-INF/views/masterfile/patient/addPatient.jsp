...
<body>
	...
	<div style="width: 100;">
		...
		<form:form action="/crmsweb/savePatient" method="post" modelAttribute="patient" cssClass="form-horizontal">
		    ...
		    <div align="center">
		    	...
		    	<label style="font-size: 24px;">Add Patient</label>		
		    </div>
						...
						<div class="form-group">
							...
							<c:choose>
								<c:when test="${isSuccess == true}">
									<input class="btn btn-default" type="button" value="Close" onclick="window.location.href = '/crmsweb/goToSearchPatient';">
								</c:when>
								<c:otherwise>
									<input class="btn btn-default" type="submit" value="Submit/Save">
									<input class="btn btn-default" type="button" value="Cancel" onclick="window.location.href = '/crmsweb/goToSearchPatient';">
								</c:otherwise>
							</c:choose>
							</div>
						</div>				
