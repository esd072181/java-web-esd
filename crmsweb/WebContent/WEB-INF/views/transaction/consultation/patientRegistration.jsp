...
<body>
	...
	<div style="width: 100%;">
		...
		<form:form action="/crmsweb/savePatientRegistration" method="post" modelAttribute="patient" cssClass="form-horizontal">
		    ...
		    <div align="center">
		    	...
		    	<label style="font-size: 24px;">Patient Registration</label>		
		    </div>
						...
						<div class="form-group">
							...
							<c:choose>
								<c:when test="${isSuccess == true}">
									<input class="btn btn-default" type="button" value="Go To Consultation Form" onclick="goToConsultation(${patient.id});">
									<input class="btn btn-default" type="button" value="Close" onclick="window.location.href = '/crmsweb/goToSearchPatientForConsultation';">
								</c:when>
								<c:otherwise>
									<input class="btn btn-default" type="submit" value="Submit/Save">
									<input class="btn btn-default" type="button" value="Cancel" onclick="window.location.href = '/crmsweb/goToSearchPatientForConsultation';">
								</c:otherwise>
							</c:choose>
							</div>
						</div>			
