...
<body>
	...
	<div style="width: 100%;">
		...
		<form:form action="/crmsweb/saveConsultation" method="post" modelAttribute="patientConsultation" cssClass="form-horizontal">
			...
			<div align="center">
				...
				<table style="width: 100%;">
					...
					<tr>
						...
						<td>
							<div class="form-group">
								<form:label path="professional.id" cssClass="col-sm-2 control-label">Physician:</form:label>
								<div class="col-xs-3">
